...
$vistaMenu     = "menu_resoluciones_gran_contribuyente";
$vistaBuscador = "buscador_resoluciones_gran_contribuyente";
...
$botones  = HTML::boton("ADICREGC",$textos["ADICIONAR"],"ejecutarComando(this,350,320);","adicionar");
$botones .= HTML::boton("CONSREGC",$textos["CONSULTAR"],"ejecutarComando(this,350,270);","consultar");
$botones .= HTML::boton("MODIREGC",$textos["MODIFICAR"],"ejecutarComando(this,350,320);","modificar");
$botones .= HTML::boton("ELIMREGC",$textos["ELIMINAR"],"ejecutarComando(this,350,270);","eliminar");
