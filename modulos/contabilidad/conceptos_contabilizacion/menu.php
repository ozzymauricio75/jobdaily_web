...
$vistaMenu     = "menu_conceptos_contabilizacion";
$vistaBuscador = "buscador_conceptos_contabilizacion";
...
$botones  = HTML::boton("ADICCOCO",$textos["ADICIONAR"],"ejecutarComando(this, 800, 470);","adicionar");
$botones .= HTML::boton("CONSCOCO",$textos["CONSULTAR"],"ejecutarComando(this, 450, 500);","consultar");
$botones .= HTML::boton("MODICOCO",$textos["MODIFICAR"],"ejecutarComando(this, 800, 470);","modificar");
$botones .= HTML::boton("ELIMCOCO",$textos["ELIMINAR"],"ejecutarComando(this, 450, 500);","eliminar");
