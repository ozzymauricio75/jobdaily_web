...
$vistaMenu     = "menu_tipos_devoluciones_compra";
$vistaBuscador = "buscador_tipos_devoluciones_compra";
...
$botones  = HTML::boton("ADICTDVC",$textos["ADICIONAR"],"ejecutarComando(this, 600, 500);","adicionar");
$botones .= HTML::boton("CONSTDVC",$textos["CONSULTAR"],"ejecutarComando(this, 600, 500);","consultar");
$botones .= HTML::boton("MODITDVC",$textos["MODIFICAR"],"ejecutarComando(this, 600, 500);","modificar");
$botones .= HTML::boton("ELIMTDVC",$textos["ELIMINAR"],"ejecutarComando(this, 600, 500);","eliminar");
