...
$vistaMenu     = "menu_tipos_documentos";
$vistaBuscador = "buscador_tipos_documentos";
$alineacion    = array("I","C","I","I","C");
...
$botones  = HTML::boton("ADICTIDO",$textos["ADICIONAR"],"ejecutarComando(this,530,530);","adicionar");
$botones .= HTML::boton("CONSTIDO",$textos["CONSULTAR"],"ejecutarComando(this,530,530);","consultar");
$botones .= HTML::boton("MODITIDO",$textos["MODIFICAR"],"ejecutarComando(this,530,530);","modificar");
$botones .= HTML::boton("ELIMTIDO",$textos["ELIMINAR"],"ejecutarComando(this,530,530);","eliminar");
