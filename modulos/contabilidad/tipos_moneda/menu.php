...
$vistaMenu     = "menu_tipos_moneda";
$vistaBuscador = "buscador_tipos_moneda";
...
$botones  = HTML::boton("ADICTIMO",$textos["ADICIONAR"],"ejecutarComando(this,420,320);","adicionar");
$botones .= HTML::boton("CONSTIMO",$textos["CONSULTAR"],"ejecutarComando(this,420,310);","consultar");
$botones .= HTML::boton("MODITIMO",$textos["MODIFICAR"],"ejecutarComando(this,420,320);","modificar");
$botones .= HTML::boton("ELIMTIMO",$textos["ELIMINAR"],"ejecutarComando(this,420,310);","eliminar");
