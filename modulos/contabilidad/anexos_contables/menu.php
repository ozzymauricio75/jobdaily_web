...
$vistaMenu     = "menu_anexos_contables";
$vistaBuscador = "buscador_anexos_contables";
...
$botones  = HTML::boton("ADICANCO",$textos["ADICIONAR"],"ejecutarComando(this,420,270);","adicionar");
$botones .= HTML::boton("CONSANCO",$textos["CONSULTAR"],"ejecutarComando(this,420,210);","consultar");
$botones .= HTML::boton("MODIANCO",$textos["MODIFICAR"],"ejecutarComando(this,420,270);","modificar");
$botones .= HTML::boton("ELIMANCO",$textos["ELIMINAR"],"ejecutarComando(this,420,210);","eliminar");
