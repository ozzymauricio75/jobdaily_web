...
$vistaMenu     = "menu_tipos_documentos_bancarios";
$vistaBuscador = "buscador_tipos_documentos_bancarios";
...
$botones  = HTML::boton("ADICTIDB",$textos["ADICIONAR"],"ejecutarComando(this,420,280);","adicionar");
$botones .= HTML::boton("CONSTIDB",$textos["CONSULTAR"],"ejecutarComando(this,420,240);","consultar");
$botones .= HTML::boton("MODITIDB",$textos["MODIFICAR"],"ejecutarComando(this,420,280);","modificar");
$botones .= HTML::boton("ELIMTIDB",$textos["ELIMINAR"],"ejecutarComando(this,420,240);","eliminar");
