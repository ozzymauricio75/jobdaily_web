...
if (!empty($url_generar)) {
    ...
    if (empty($url_id)) {
        ...
        $vistaConsulta = "tipos_documentos_bancarios";
...
/*** Validar los datos provenientes del formulario ***/
    ...
    if ($url_item == "codigo_interno") {
        $existe = SQL::existeItem("tipos_documentos_bancarios", "codigo", $url_valor, "codigo!= '0' AND codigo != $url_id");
    ...
    if ($url_item == "descripcion") {
        $existe = SQL::existeItem("tipos_documentos_bancarios", "descripcion", $url_valor, "descripcion != '' AND codigo!= $url_id");
...
/*** Modificar el elemento seleccionado ***/
    ...
    if(empty($forma_codigo_interno)){
    ...
    }elseif($existe = SQL::existeItem("tipos_documentos_bancarios", "codigo", $forma_codigo,"codigo != '' AND codigo !='$forma_id'")){
	    $error   = true;
        $mensaje = $textos["ERROR_EXISTE_CODIGO"];
        
    }elseif($existe = SQL::existeItem("tipos_documentos_bancarios", "descripcion", $forma_descripcion,"descripcion != '' AND codigo !='$forma_id'")){
	    $error   = true;
        ...
        $consulta = SQL::modificar("tipos_documentos_bancarios", $datos, "codigo = '$forma_id'");
