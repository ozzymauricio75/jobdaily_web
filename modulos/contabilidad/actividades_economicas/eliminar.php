...
/*** Eliminar el elemento seleccionado ***/
    ...
    $id_actividad                 = explode("|",$forma_id);
    $codigo_iso                 = $id_actividad[0];
    $codigo_dane_departamento   = $id_actividad[1];
    $codigo_dane_municipio      = $id_actividad[2];
    $codigo_dian                = $id_actividad[3];
    $codigo_actividad_municipio = $id_actividad[4];
    $condicion     = "codigo_iso ='$codigo_iso' AND codigo_dane_departamento='$codigo_dane_departamento' AND codigo_dane_municipio ='$codigo_dane_municipio'";
    $condicion     .= " AND codigo_dian ='$codigo_dian' AND codigo_actividad_municipio='$codigo_actividad_municipio'";

    $consulta = SQL::eliminar("actividades_economicas", $condicion);
