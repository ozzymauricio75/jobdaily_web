...
$botones  = HTML::boton("ADICAECO",$textos["ADICIONAR"],"ejecutarComando(this,500,430);","adicionar");
$botones .= HTML::boton("CONSAECO",$textos["CONSULTAR"],"ejecutarComando(this,450,350);","consultar");
$botones .= HTML::boton("MODIAECO",$textos["MODIFICAR"],"ejecutarComando(this,500,430);","modificar");
$botones .= HTML::boton("ELIMAECO",$textos["ELIMINAR"],"ejecutarComando(this,450,350);","eliminar");
$botones .= HTML::boton("LISTAECO",$textos["EXPORTAR"],"ejecutarComando(this,400,320);","exportar");
