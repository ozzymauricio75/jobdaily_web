...
$vistaMenu     = "menu_resoluciones_ica";
$vistaBuscador = "buscador_resoluciones_ica";
...
$botones  = HTML::boton("ADICREIC",$textos["ADICIONAR"],"ejecutarComando(this,460,320);","adicionar");
$botones .= HTML::boton("CONSREIC",$textos["CONSULTAR"],"ejecutarComando(this,440,260);","consultar");
$botones .= HTML::boton("MODIREIC",$textos["MODIFICAR"],"ejecutarComando(this,460,320);","modificar");
$botones .= HTML::boton("ELIMREIC",$textos["ELIMINAR"],"ejecutarComando(this,440,260);","eliminar");
