...
$vistaMenu     = "menu_conceptos_devolucion_compras";
$vistaBuscador = "buscador_conceptos_devolucion_compras";
...
$botones  = HTML::boton("ADICCDCO",$textos["ADICIONAR"],"ejecutarComando(this, 530, 480);","adicionar");
$botones .= HTML::boton("CONSCDCO",$textos["CONSULTAR"],"ejecutarComando(this, 500, 400);","consultar");
$botones .= HTML::boton("MODICDCO",$textos["MODIFICAR"],"ejecutarComando(this, 530, 480);","modificar");
$botones .= HTML::boton("ELIMCDCO",$textos["ELIMINAR"],"ejecutarComando(this, 500, 400);","eliminar");
