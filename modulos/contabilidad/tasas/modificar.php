...
/*** Validar los datos provenientes del formulario ***/
    ...
    /*** Validar nmbre ***/
    if ($url_item == "codigo") {
        $existe = SQL::existeItem("tasas", "codigo", $url_valor, "codigo !='0' and codigo!='$url_id'");
    ...
    if ($url_item == "descripcion") {
        $existe = SQL::existeItem("tasas", "descripcion", $url_valor, "descripcion !='' and codigo!='$forma_id'");
...
/*** Modificar el elemento seleccionado ***/
    ...
    $mensaje = $textos["ITEM_ADICIONADO"];
     ...
     if(empty($forma_codigo)){
    ...
    }elseif($existe = SQL::existeItem("tasas", "codigo", $forma_codigo,"codigo !='0' and codigo!='$forma_id'")){
	    $error   = true;
        $mensaje = $textos["ERROR_EXISTE_CODIGO"];
    }elseif($existe = SQL::existeItem("tasas", "descripcion", $forma_descripcion,"descripcion !='' and codigo!='$forma_id'")){
	    $error   = true;
        ...
        $consulta = SQL::modificar("tasas", $datos, "codigo = '$forma_id'");
