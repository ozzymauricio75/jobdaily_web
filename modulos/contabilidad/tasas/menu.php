...
$botones  = HTML::boton("ADICTASA",$textos["ADICIONAR"],"ejecutarComando(this,360,360);","adicionar");
$botones .= HTML::boton("CONSTASA",$textos["CONSULTAR"],"ejecutarComando(this,330,240);","consultar");
$botones .= HTML::boton("MODITASA",$textos["MODIFICAR"],"ejecutarComando(this,350,300);","modificar");
$botones .= HTML::boton("ELIMTASA",$textos["ELIMINAR"],"ejecutarComando(this,330,250);","eliminar");
$botones .= HTML::boton("EXPOTASA",$textos["EXPORTAR"],"ejecutarComando(this,330,250);","exportar");
