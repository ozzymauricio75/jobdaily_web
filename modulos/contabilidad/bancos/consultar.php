    ...
    if (empty($url_id)) {
        ...
        if(isset($item_sucursal)){
            $formularios["PESTANA_SUCURSALES"] = array(
                array(
                    HTML::generarTabla(
                        array("id","CODIGO","NOMBRE_SUCURSAL","MUNICIPIO_SUCURSAL","DIRECCION_SUCURSAL","TELEFONO_SUCURSAL","CONTACTO","CELULAR_SUCURSAL","CORREO_SUCURSAL"),
                        $item_sucursal,
                        array("C","I","I","I","D","I","C","I"),
