...
$vistaMenu     = "menu_terceros";
$vistaBuscador = "buscador_terceros";
...
$botones  = HTML::boton("ADICTERC",$textos["ADICIONAR"],"ejecutarComando(this,650,470);","adicionar");
$botones .= HTML::boton("CONSTERC",$textos["CONSULTAR"],"ejecutarComando(this,600,540);","consultar");
$botones .= HTML::boton("MODITERC",$textos["MODIFICAR"],"ejecutarComando(this,650,500);","modificar");
$botones .= HTML::boton("ELIMTERC",$textos["ELIMINAR"],"ejecutarComando(this,600,540);","eliminar");
$botones .= HTML::boton("LISTTERC",$textos["EXPORTAR"],"ejecutarComando(this,500,380);","exportar");
...
$columnas       = array("id","DOCUMENTO_IDENTIDAD","NOMBRE_COMPLETO");
