...
$vistaMenu     = "menu_actividades_economicas_dian";
$vistaBuscador = "buscador_actividades_economicas_dian";
...
$botones  = HTML::boton("ADICACDI",$textos["ADICIONAR"],"ejecutarComando(this,350,270);","adicionar");
$botones .= HTML::boton("CONSACDI",$textos["CONSULTAR"],"ejecutarComando(this,350,270);","consultar");
$botones .= HTML::boton("MODIACDI",$textos["MODIFICAR"],"ejecutarComando(this,350,270);","modificar");
$botones .= HTML::boton("ELIMACDI",$textos["ELIMINAR"],"ejecutarComando(this,350,270);","eliminar");
$botones .= HTML::boton("LISTACDI",$textos["EXPORTAR"],"ejecutarComando(this,420,250);","exportar");
