...
$vistaMenu     = "menu_tipos_compras";
$vistaBuscador = "buscador_tipos_compras";
...
$botones  = HTML::boton("ADICTCOM",$textos["ADICIONAR"],"ejecutarComando(this, 600, 520);","adicionar");
$botones .= HTML::boton("CONSTCOM",$textos["CONSULTAR"],"ejecutarComando(this, 600, 500);","consultar");
$botones .= HTML::boton("MODITCOM",$textos["MODIFICAR"],"ejecutarComando(this, 600, 520);","modificar");
$botones .= HTML::boton("ELIMTCOM",$textos["ELIMINAR"],"ejecutarComando(this, 600, 500);","eliminar");
