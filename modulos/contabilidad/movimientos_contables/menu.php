...
$vistaMenu     = "menu_movimientos_contables";
$vistaBuscador = "buscador_movimientos_contables";
$alineacion    = array("I","I","C","D","I","I");
...
$botones  = HTML::boton("ADICMOCO",$textos["ADICIONAR"],"ejecutarComando(this,1100,650);","adicionar");
$botones .= HTML::boton("CONSMOCO",$textos["CONSULTAR"],"ejecutarComando(this,1100,450);","consultar");
//$botones .= HTML::boton("MODIMOCO",$textos["MODIFICAR"],"ejecutarComando(this,1100,650);","modificar");
$botones .= HTML::boton("ANULMOCO",$textos["ANULAR"],"ejecutarComando(this,1100,450);","anular");
//$botones .= HTML::boton("REPOMOCO",$textos["REPORTES"],"ejecutarComando(this,480,350);","exportar");
...
$agrupamiento   = "";
$ordenamiento   = SQL::ordenColumnas("FECHA,TERCERO,TIPO_DOCUMENTO,CONSECUTIVO_DOCUMENTO,SUCURSAL");
