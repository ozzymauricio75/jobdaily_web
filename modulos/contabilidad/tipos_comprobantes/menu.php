...
$vistaMenu     = "menu_tipos_comprobantes";
$vistaBuscador = "buscador_tipos_comprobantes";
...
$botones  = HTML::boton("ADICTICO",$textos["ADICIONAR"],"ejecutarComando(this,420,270);","adicionar");
$botones .= HTML::boton("CONSTICO",$textos["CONSULTAR"],"ejecutarComando(this,420,210);","consultar");
$botones .= HTML::boton("MODITICO",$textos["MODIFICAR"],"ejecutarComando(this,420,270);","modificar");
$botones .= HTML::boton("ELIMTICO",$textos["ELIMINAR"],"ejecutarComando(this,420,210);","eliminar");
