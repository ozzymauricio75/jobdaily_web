...
// Exportar los datos
    ...
    if (empty($forma_fecha_saldo) || !isset($forma_sucursales)) {
        ...
        foreach ($sucursales_reporte AS $sucursal => $condicion_sucursal) {
            ...
            marcarTitulosCXC($archivo,$textos,$sucursal);
            ...
            $columnas  = array("*");
            $condicion = "maneja_saldos = '1' AND maneja_tercero = '1' AND naturaleza_cuenta = 'D'";
            ...
            if(SQL::filasDevueltas($consulta_item)){
                $contador_items++;
                adicionarPaginaCXC($textos,$forma_fecha_saldo,$nombre_sucursal,$consolidadas,$sucursal,$archivo);
                ...
                while($datos_saldos = SQL::filaEnObjeto($consulta_saldos)){
                    ...
                    if($datos_saldos->id_saldo != NULL){
                        ...
                        if( $cuenta_actual != $datos_saldos->id_item_movimiento ){                            
                            if(!imprimirCabeceraCXC($archivo,$textos,$tercero,$descripcion_documento,$consecutivo_documento,$total_factura,10)){
                        ...
                        //Fecha Por vencer > 30 dias
                        if($fecha_vencimiento > $fecha_por_vencer && $diferencia>0){
                            imprimirCabeceraCXC($archivo,$textos,$tercero,$descripcion_documento,$consecutivo_documento,$total_factura,5);
                            colorCeldas($archivo);
