...
$vistaMenu     = "menu_conceptos_dian";
$vistaBuscador = "buscador_conceptos_dian";
$alineacion    = array("I","C","I","D");
...
$botones  = HTML::boton("ADICCODI",$textos["ADICIONAR"],"ejecutarComando(this,600,430);","adicionar");
$botones .= HTML::boton("CONSCODI",$textos["CONSULTAR"],"ejecutarComando(this,600,410);","consultar");
$botones .= HTML::boton("MODICODI",$textos["MODIFICAR"],"ejecutarComando(this,600,430);","modificar");
$botones .= HTML::boton("ELIMCODI",$textos["ELIMINAR"],"ejecutarComando(this,600,410);","eliminar");
