...
if (!empty($url_generar)) {
    ...
    $formularios["PESTANA_GENERAL"] = array(
        array(
            HTML::campoTextoCorto("*numero_retefuente", $textos["NUMERO"], 15, 20, "", array("title" => $textos["AYUDA_NUMERO"],"onBlur" => "validarItem(this);"))
        ),
        array(
...
/*** validacion de los datos ***/
    ...
    if ($url_item == "numero_retefuente") {
        $existe = SQL::existeItem("resoluciones_retefuente", "numero_retefuente", $url_valor,"numero_retefuente !=''");
...
/*** Adicionar los datos provenientes del formulario ***/
    ...
    if(empty($forma_descripcion)){
    ...
    }elseif(SQL::existeItem("resoluciones_retefuente", "numero_retefuente", $forma_numero_retefuente,"numero_retefuente !=''")){
	    $error   = true;
        ...
        $insertar = SQL::insertar("resoluciones_retefuente", $datos);
