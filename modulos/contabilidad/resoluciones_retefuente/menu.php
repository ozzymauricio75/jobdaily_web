...
$vistaMenu     = "menu_resoluciones_retefuente";
$vistaBuscador = "buscador_resoluciones_retefuente";
...
$botones  = HTML::boton("ADICRERF",$textos["ADICIONAR"],"ejecutarComando(this,350,320);","adicionar");
$botones .= HTML::boton("CONSRERF",$textos["CONSULTAR"],"ejecutarComando(this,350,270);","consultar");
$botones .= HTML::boton("MODIRERF",$textos["MODIFICAR"],"ejecutarComando(this,350,320);","modificar");
$botones .= HTML::boton("ELIMRERF",$textos["ELIMINAR"],"ejecutarComando(this,350,270);","eliminar");
