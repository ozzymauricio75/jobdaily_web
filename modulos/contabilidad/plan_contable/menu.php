...
$vistaMenu     = "menu_plan_contable";
$vistaBuscador = "buscador_plan_contable";
...
$botones  = HTML::boton("ADICPLCO",$textos["ADICIONAR"],"ejecutarComando(this,850,480);","adicionar");
$botones .= HTML::boton("CONSPLCO",$textos["CONSULTAR"],"ejecutarComando(this,850,480);","consultar");
$botones .= HTML::boton("MODIPLCO",$textos["MODIFICAR"],"ejecutarComando(this,850,480);","modificar");
$botones .= HTML::boton("ELIMPLCO",$textos["ELIMINAR"],"ejecutarComando(this,850,480);","eliminar");
$botones .= HTML::boton("LISTPLCO",$textos["EXPORTAR"],"ejecutarComando(this,560,330);","exportar");
...
$agrupamiento   = "";
$ordenamiento   = SQL::ordenColumnas("CODIGO_CONTABLE");
