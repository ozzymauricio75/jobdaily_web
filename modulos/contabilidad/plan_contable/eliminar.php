...
/*** Eliminar el elemento seleccionado ***/
    ...
    $consulta = SQL::seleccionar(array("plan_contable"),array("codigo_contable"),"codigo_contable_padre='$forma_id' OR codigo_contable_consolida='$forma_id'");

    if (SQL::filasDevueltas($consulta)){
        $error   = true;
        $mensaje = $textos["ERROR_ELIMINAR_CODIGO"];
    } else {

        $consulta = SQL::eliminar("plan_contable", "codigo_contable = '$forma_id'");
