...
$vistaMenu     = "menu_formatos_dian";
$vistaBuscador = "buscador_formatos_dian";
...
$botones  = HTML::boton("ADICFODI",$textos["ADICIONAR"],"ejecutarComando(this,450,270);","adicionar");
$botones .= HTML::boton("CONSFODI",$textos["CONSULTAR"],"ejecutarComando(this,450,250);","consultar");
$botones .= HTML::boton("MODIFODI",$textos["MODIFICAR"],"ejecutarComando(this,450,270);","modificar");
$botones .= HTML::boton("ELIMFODI",$textos["ELIMINAR"],"ejecutarComando(this,450,250);","eliminar");
