...
$vistaMenu     = "menu_planillas";
$vistaBuscador = "buscador_planillas";
...
$botones  = HTML::boton("ADICPLAN",$textos["ADICIONAR"],"ejecutarComando(this,430,320);","adicionar");
$botones .= HTML::boton("CONSPLAN",$textos["CONSULTAR"],"ejecutarComando(this,300,200);","consultar");
$botones .= HTML::boton("MODIPLAN",$textos["MODIFICAR"],"ejecutarComando(this,430,320);","modificar");
$botones .= HTML::boton("ELIMPLAN",$textos["ELIMINAR"],"ejecutarComando(this,300,200);","eliminar");
