...
$vistaMenu     = "menu_domingos_festivos";
$vistaBuscador = "buscador_domingos_festivos";
$alineacion    = array("I");
...
$botones  = HTML::boton("ADICDOFE",$textos["ADICIONAR"],"ejecutarComando(this,400,400);","adicionar");
$botones .= HTML::boton("CONSDOFE",$textos["CONSULTAR"],"ejecutarComando(this,290,290);","consultar");
$botones .= HTML::boton("MODIDOFE",$textos["MODIFICAR"],"ejecutarComando(this,450,300);","modificar");
$botones .= HTML::boton("ELIMDOFE",$textos["ELIMINAR"],"ejecutarComando(this,400,300);","eliminar");
