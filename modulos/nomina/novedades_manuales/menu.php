...
$vistaMenu     = "menu_movimiento_novedades_manuales ";
$vistaBuscador = "buscador_movimiento_novedades_manuales";
$alineacion    = array("I","I","I","C");
...
$botones  = HTML::boton("ADICNOMA",$textos["ADICIONAR"],"ejecutarComando(this,700,450);","adicionar");
$botones .= HTML::boton("CONSNOMA",$textos["CONSULTAR"],"ejecutarComando(this,550,350);","consultar");
$botones .= HTML::boton("MODINOMA",$textos["MODIFICAR"],"ejecutarComando(this,700,450);","modificar");
$botones .= HTML::boton("ELIMNOMA",$textos["ELIMINAR"],"ejecutarComando(this,550,350);","eliminar");
$botones .= HTML::boton("LISTNOMA",$textos["EXPORTAR"],"ejecutarComando(this,400,400);","exportar");
