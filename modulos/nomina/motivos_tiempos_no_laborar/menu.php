...
/**
*
* Copyright (C) 2008 Sistema de Apoyo Empresarial Ltda
* 
*
...
$vistaMenu     = "menu_motivos_tiempo_no_laborado";
$vistaBuscador = "buscador_motivos_tiempo_no_laborado";
...
$botones  = HTML::boton("ADICNOLA",$textos["ADICIONAR"],"ejecutarComando(this,380,300);","adicionar");
$botones .= HTML::boton("CONSNOLA",$textos["CONSULTAR"],"ejecutarComando(this,380,250);","consultar");
$botones .= HTML::boton("MODINOLA",$textos["MODIFICAR"],"ejecutarComando(this,380,300);","modificar");
$botones .= HTML::boton("ELIMNOLA",$textos["ELIMINAR"],"ejecutarComando(this,380,260);","eliminar");
