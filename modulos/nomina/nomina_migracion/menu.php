...
$vistaMenu     = "menu_nomina_migracion";
$vistaBuscador = "buscador_nomina_migracion";
$alineacion    = array("I","I","I","C","D");
...
$botones  = HTML::boton("ADICNMIG",$textos["ADICIONAR"],"ejecutarComando(this,500,500);","adicionar");
$botones .= HTML::boton("CONSNMIG",$textos["CONSULTAR"],"ejecutarComando(this,500,500);","consultar");
$botones .= HTML::boton("MODINMIG",$textos["MODIFICAR"],"ejecutarComando(this,500,500);","modificar");
$botones .= HTML::boton("ELIMNMIG",$textos["ELIMINAR"],"ejecutarComando(this,500,500);","eliminar");
$botones .= HTML::boton("LISTNMIG",$textos["EXPORTAR"],"ejecutarComando(this,500,500);","exportar");
