...
if(isset($url_verificar_periodo_contable)){
     $consulta = SQL::seleccionar(array("periodos_contables_modulos"),array("*"),"codigo_sucursal='$url_codigo_sucursal' AND ('$url_fecha_inicio' BETWEEN fecha_inicio AND fecha_fin) AND id_modulo='$url_id_modulo'");
...
if (isset($url_generarTiempos)){
    ...
    for($i=0;$i<$url_fecha_dias;$i++)
    {
        ...
        $consulta = SQL::seleccionar(array("periodos_contables_modulos"),array("*"),"codigo_sucursal='$url_codigo_sucursal' AND ('$fecha_resultado' BETWEEN fecha_inicio AND fecha_fin) AND id_modulo='$url_id_modulo'");
        if(SQL::filasDevueltas($consulta)){
