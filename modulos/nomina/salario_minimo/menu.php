...
$vistaMenu     = "menu_salario_minimo";
$vistaBuscador = "buscador_salario_minimo";
...
$botones  = HTML::boton("ADICSMLV",$textos["ADICIONAR"],"ejecutarComando(this,280,300);","adicionar");
$botones .= HTML::boton("CONSSMLV",$textos["CONSULTAR"],"ejecutarComando(this,280,250);","consultar");
$botones .= HTML::boton("MODISMLV",$textos["MODIFICAR"],"ejecutarComando(this,280,300);","modificar");
$botones .= HTML::boton("ELIMSMLV",$textos["ELIMINAR"],"ejecutarComando(this,280,250);","eliminar");
