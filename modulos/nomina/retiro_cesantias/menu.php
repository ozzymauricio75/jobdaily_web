...
$vistaMenu     = "menu_retiro_cesantias";
...
$botones  = HTML::boton("ADICRECE",$textos["ADICIONAR"],"ejecutarComando(this,700,525);","adicionar");
$botones .= HTML::boton("CONSRECE",$textos["CONSULTAR"],"ejecutarComando(this,500,300);","consultar");
$botones .= HTML::boton("MODIRECE",$textos["MODIFICAR"],"ejecutarComando(this,700,500);","modificar");
$botones .= HTML::boton("ELIMRECE",$textos["ELIMINAR"],"ejecutarComando(this,300,200);","eliminar");
