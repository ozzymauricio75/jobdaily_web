...
$vistaMenu     = "menu_conceptos_prestamos";
$vistaBuscador = "buscador_conceptos_prestamos";
...
$botones  = HTML::boton("ADICCOPR",$textos["ADICIONAR"],"ejecutarComando(this,380,260);","adicionar");
$botones .= HTML::boton("CONSCOPR",$textos["CONSULTAR"],"ejecutarComando(this,380,250);","consultar");
$botones .= HTML::boton("MODICOPR",$textos["MODIFICAR"],"ejecutarComando(this,380,260);","modificar");
$botones .= HTML::boton("ELIMCOPR",$textos["ELIMINAR"],"ejecutarComando(this,380,260);","eliminar");
