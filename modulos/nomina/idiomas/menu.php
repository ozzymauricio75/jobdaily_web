...
$vistaMenu     = "menu_idiomas";
$vistaBuscador = "buscador_idiomas";
...
$botones  = HTML::boton("ADICIDIO",$textos["ADICIONAR"],"ejecutarComando(this,380,260);","adicionar");
$botones .= HTML::boton("CONSIDIO",$textos["CONSULTAR"],"ejecutarComando(this,380,250);","consultar");
$botones .= HTML::boton("MODIIDIO",$textos["MODIFICAR"],"ejecutarComando(this,380,260);","modificar");
$botones .= HTML::boton("ELIMIDIO",$textos["ELIMINAR"],"ejecutarComando(this,380,260);","eliminar");
