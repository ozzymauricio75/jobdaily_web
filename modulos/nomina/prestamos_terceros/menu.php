...
$vistaMenu      = "menu_control_prestamos_terceros";
...
$botones  = HTML::boton("ADICPTTE",$textos["ADICIONAR"],"ejecutarComando(this,700,400);","adicionar");
$botones .= HTML::boton("CONSPTTE",$textos["CONSULTAR"],"ejecutarComando(this,500,500);","consultar");
$botones .= HTML::boton("MODIPTTE",$textos["MODIFICAR"],"ejecutarComando(this,700,450);","modificar");
$botones .= HTML::boton("LISTPTTE",$textos["EXPORTAR"],"ejecutarComando(this,500,400);","exportar");
