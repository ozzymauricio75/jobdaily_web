...
$vistaMenu     = "menu_transacciones_contables_empleado";
$vistaBuscador = "buscador_transacciones_contables_empleado";
...
$botones  = HTML::boton("ADICTRCO",$textos["ADICIONAR"],"ejecutarComando(this,500,500);","adicionar");
$botones .= HTML::boton("CONSTRCO",$textos["CONSULTAR"],"ejecutarComando(this,500,500);","consultar");
$botones .= HTML::boton("MODITRCO",$textos["MODIFICAR"],"ejecutarComando(this,500,500);","modificar");
$botones .= HTML::boton("ELIMTRCO",$textos["ELIMINAR"],"ejecutarComando(this,500,500);","eliminar");
$botones .= HTML::boton("LISTTRCO",$textos["EXPORTAR"],"ejecutarComando(this,400,400);","exportar");
...
$agrupamiento   = "";
$ordenamiento   = SQL::ordenColumnas("CONCEPTO_CONTABLE DESC");
