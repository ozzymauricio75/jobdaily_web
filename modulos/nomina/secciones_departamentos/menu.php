...
$vistaMenu     = "menu_secciones_departamentos";
$vistaBuscador = "buscador_secciones_departamentos";
...
$botones  = HTML::boton("ADICSCDE",$textos["ADICIONAR"],"ejecutarComando(this,410,300);","adicionar");
$botones .= HTML::boton("CONSSCDE",$textos["CONSULTAR"],"ejecutarComando(this,410,300);","consultar");
$botones .= HTML::boton("MODISCDE",$textos["MODIFICAR"],"ejecutarComando(this,410,300);","modificar");
$botones .= HTML::boton("ELIMSCDE",$textos["ELIMINAR"],"ejecutarComando(this,410,300);","eliminar");
$botones .= HTML::boton("LISTSCDE",$textos["EXPORTAR"],"ejecutarComando(this,350,350);","exportar");
