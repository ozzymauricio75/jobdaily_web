...
$textos = array(
    "GESTAFIC"                    => "Aficiones",
    "ADICAFIC"                    => "Adicionar Aficion",
    "CONSAFIC"                    => "Consultar Aficion",
    "MODIAFIC"                    => "Modificar Aficion",
    "ELIMAFIC"                    => "Eliminar Aficion",
    "DESCRIPCION_AFICION"         => "Descripcion",
    "CODIGO_AFICION"              => "Codigo",
    "RIESGOS_PROFESIONALES"       => "Riesgos Profesionales",
    "AYUDA_AFICION"		            => "Codigo Aficion",
    "AYUDA_NOMBRE_AFICION"        => "Nombre de la Aficion ",
    "PESTANA_GENERAL"         	  => "Información General",
    "ERROR_EXISTE_NOMBRE_AFICION" => "Ya existe una Afición con ese nombre",
    "ERROR_EXISTE_AFICION"        => "Ya existe una Afición con ese código",
    "CODIGO"                      => "Código",
