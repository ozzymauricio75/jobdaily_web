...
$vistaMenu     = "menu_aficiones";
$vistaBuscador = "buscador_aficiones";
...
$botones  = HTML::boton("ADICAFIC",$textos["ADICIONAR"],"ejecutarComando(this,380,260);","adicionar");
$botones .= HTML::boton("CONSAFIC",$textos["CONSULTAR"],"ejecutarComando(this,380,250);","consultar");
$botones .= HTML::boton("MODIAFIC",$textos["MODIFICAR"],"ejecutarComando(this,380,260);","modificar");
$botones .= HTML::boton("ELIMAFIC",$textos["ELIMINAR"],"ejecutarComando(this,380,260);","eliminar");
