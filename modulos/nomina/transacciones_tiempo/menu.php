...
$vistaMenu     = "menu_transacciones_tiempo";
$vistaBuscador = "buscador_transacciones_tiempo";
...
$botones  = HTML::boton("ADICTRTI",$textos["ADICIONAR"],"ejecutarComando(this,550,450);","adicionar");
$botones .= HTML::boton("CONSTRTI",$textos["CONSULTAR"],"ejecutarComando(this,550,450);","consultar");
$botones .= HTML::boton("MODITRTI",$textos["MODIFICAR"],"ejecutarComando(this,550,450);","modificar");
$botones .= HTML::boton("ELIMTRTI",$textos["ELIMINAR"],"ejecutarComando(this,550,450);","eliminar");
$botones .= HTML::boton("LISTTRTI",$textos["EXPORTAR"],"ejecutarComando(this,400,300);","exportar");
...
$agrupamiento   = "";
$ordenamiento   = SQL::ordenColumnas("NOMBRE DESC");
