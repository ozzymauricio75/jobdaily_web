...
$vistaMenu     = "menu_ingreso_empleados";
$vistaBuscador = "buscador_ingreso_empleados";
...
$botones  = HTML::boton("ADICINEM",$textos["ADICIONAR"],"ejecutarComando(this,900,440);","adicionar");
$botones .= HTML::boton("CONSINEM",$textos["CONSULTAR"],"ejecutarComando(this,900,400);","consultar");
$botones .= HTML::boton("MODIINEM",$textos["MODIFICAR"],"ejecutarComando(this,900,400);","modificar");
$botones .= HTML::boton("RETIINEM",$textos["RETIRO"],"ejecutarComando(this,720,900);","regresar");
$botones .= HTML::boton("LISTINEM",$textos["EXPORTAR"],"ejecutarComando(this,500,430);","exportar");
