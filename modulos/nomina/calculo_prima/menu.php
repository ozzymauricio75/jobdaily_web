...
$botones  = HTML::boton("ADICPLAN",$textos["ADICIONAR"],"ejecutarComando(this,350,300);","adicionar");
$botones .= HTML::boton("CONSPLAN",$textos["CONSULTAR"],"ejecutarComando(this,300,200);","consultar");
$botones .= HTML::boton("MODIPLAN",$textos["MODIFICAR"],"ejecutarComando(this,350,300);","modificar");
