    ...
    if (empty($url_id)) {
        ...
        if($datos_aspirante->relacion_laboral == 1){
         ...
         if($datos_aspirante->pensionado == 1){
            ...
            /*** Definición de pestaña de la informacion profesional ***/
       ...
       $tablaDeporte  = HTML::generarTabla($columnasDeporte, $itemDeporte, $alineacionDeporte,"tablaDeporte",false);
        ...
        while($datosVivienda    = SQL::filaEnObjeto($consultaVivienda)){
            ...
            /*
            $llave_primaria_municipio_vivienda = $datosVivienda->codigo_iso_vivienda."|".$datosVivienda->codigo_dane_departamento_vivienda."|".$datosVivienda->codigo_dane_municipio_vivienda;
            $municipioVivienda = SQL::obtenerValor("seleccion_municipios","SUBSTRING_INDEX(nombre,'|',1)","id = '$llave_primaria_municipio_vivienda'");
            */
