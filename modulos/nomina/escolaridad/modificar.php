...
/*** Validar los datos provenientes del formulario ***/
    ...
    if (isset($url_valor)) {
        $existe = SQL::existeItem("escolaridad", "codigo", $url_valor, "codigo != '$url_id' AND codigo != '' ");
        $existenombre = SQL::existeItem("escolaridad", "descripcion", $url_valor, "codigo != '$url_id' AND descripcion != ''");
...
/*** Modificar el elemento seleccionado ***/
    ...
    if(empty($forma_codigo) || (empty($forma_descripcion))){
    ...
    }elseif($existe = SQL::existeItem("escolaridad", "codigo", $forma_codigo,"codigo != '$forma_id' AND codigo != ''")){
        $error = true;
        $mensaje = $textos["ERROR_EXISTE_DEPORTE"];
    
    }elseif($existe = SQL::existeItem("escolaridad", "descripcion", $forma_descripcion,"codigo != '$forma_id' AND descripcion != ''")){
        $error = true;
        ...
        $modificar = SQL::modificar("escolaridad", $datos, "codigo = '$forma_id'");
