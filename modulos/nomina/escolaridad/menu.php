...
$vistaMenu     = "menu_escolaridad";
$vistaBuscador = "buscador_escolaridad";
...
$botones  = HTML::boton("ADICESCO",$textos["ADICIONAR"],"ejecutarComando(this,380,260);","adicionar");
$botones .= HTML::boton("CONSESCO",$textos["CONSULTAR"],"ejecutarComando(this,380,250);","consultar");
$botones .= HTML::boton("MODIESCO",$textos["MODIFICAR"],"ejecutarComando(this,380,260);","modificar");
$botones .= HTML::boton("ELIMESCO",$textos["ELIMINAR"],"ejecutarComando(this,380,260);","eliminar");
