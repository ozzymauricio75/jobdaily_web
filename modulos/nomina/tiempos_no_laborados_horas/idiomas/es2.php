...
**/
$textos = array(
    "GESTRETH"                                      => "Reporte de tiempos no laborados por horas",
    "ADICRETH"                                      => "Adicionar reporte de tiempos no laborados por horas",
    "CONSRETH"                                      => "Consultar reporte de tiempos no laborados por horas",
    "MODIRETH"                                      => "Modificar reporte de tiempos no laborados por horas",
    "ELIMRETH"                                      => "Eliminar reporte de tiempos no laborados por horas",
    "LISTRETH"                                      => "Listar reporte de tiempos no laborados por horas",
    "REPORTE_HORAS"                                 => "Reporte de tiempos no laborados por horas",
    ...
    "CONTABILIZADO_MOVIMIENTO"                      => "los tiempo registrados ya fue leida por salario y/o pagada.",
    ...
    "TIPO_TURNO_CONTINUO"                           => "Turno continuo de ",
    "TIPO_TURNO_DISCONTINUO"                        => "Turno discontinuo de ",
    "A"                                             => " a ",
    "Y"                                             => " y ",
    "MESAJE_DIA_DESCASO"                            => "La fecha seleccionado se encuentra marcada como dia de descanso",
    "ERROR_RANGO_HORA"                              => "Error el rango de horas seleccionada se encuentra fuera del turno laboral del empleado o el rango es incorrecto",
    "ERROR_VACIO_EMPLEADO"                          => "Por favor seleccione un nombre de empleado",
    "ERROR_VACIO_TRANSACCION"                       => "Por favor seleccione una tipo transaccion ",
    "ERROR_VACIO_FECHA_REPORTE"                     => "Por favor seleccione una fecha de reporte ",
    "ERROR_VACIO_HORA_INICIO"                       => "Por favor seleccione una hora Inicial ",
    "ERROR_VACIO_HORA_FINAL"                        => "Por favor seleccione una hora Final",
    ...
    "VIERNES"                                       => "viernes",
    "SABADO"                                        => "sabado",
    "ERROR_EXISTE_CRUCE"                            => "Error, existe un cruce de tiempos ya reportados en este rango de horas y fecha para este empleado",
