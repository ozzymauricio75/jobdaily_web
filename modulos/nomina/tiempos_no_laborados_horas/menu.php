...
$vistaMenu     = "menu_movimiento_tiempos_no_laborados_horas";
$vistaBuscador = "buscador_movimiento_tiempos_no_laborados_horas";
$alineacion    = array("I","I","C","C");
...
$botones  = HTML::boton("ADICRETH",$textos["ADICIONAR"],"ejecutarComando(this,700,450);","adicionar");
$botones .= HTML::boton("CONSRETH",$textos["CONSULTAR"],"ejecutarComando(this,550,450);","consultar");
$botones .= HTML::boton("MODIRETH",$textos["MODIFICAR"],"ejecutarComando(this,700,450);","modificar");
$botones .= HTML::boton("ELIMRETH",$textos["ELIMINAR"],"ejecutarComando(this,550,450);","eliminar");
$botones .= HTML::boton("LISTRETH",$textos["EXPORTAR"],"ejecutarComando(this,550,450);","exportar");
