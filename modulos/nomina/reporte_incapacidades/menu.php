...
$vistaMenu      = "menu_reporte_incapacidades";
$vistaBuscador  = "buscador_reporte_incapacidades";
...
$botones  = HTML::boton("ADICREIN",$textos["ADICIONAR"],"ejecutarComando(this,670,460);","adicionar");
$botones .= HTML::boton("CONSREIN",$textos["CONSULTAR"],"ejecutarComando(this,650,400);","consultar");
$botones .= HTML::boton("MODIREIN",$textos["MODIFICAR"],"ejecutarComando(this,670,460);","modificar");
$botones .= HTML::boton("ELIMREIN",$textos["ELIMINAR"],"ejecutarComando(this,650,400);","eliminar");
$botones .= HTML::boton("LISTREIN",$textos["EXPORTAR"],"ejecutarComando(this,650,400);","exportar");
...
$agrupamiento   = "";
$ordenamiento   = SQL::ordenColumnas("FECHA_INCAPACIDAD_INICIO");
