...
$vistaMenu     = "menu_gastos_prestaciones_sociales";
$vistaBuscador = "buscador_gastos_prestaciones_sociales";
...
$botones  = HTML::boton("ADICCGPS",$textos["ADICIONAR"],"ejecutarComando(this,800,450);","adicionar");
$botones .= HTML::boton("CONSCGPS",$textos["CONSULTAR"],"ejecutarComando(this,800,400);","consultar");
$botones .= HTML::boton("MODICGPS",$textos["MODIFICAR"],"ejecutarComando(this,800,450);","modificar");
$botones .= HTML::boton("ELIMCGPS",$textos["ELIMINAR"],"ejecutarComando(this,800,400);","eliminar");
