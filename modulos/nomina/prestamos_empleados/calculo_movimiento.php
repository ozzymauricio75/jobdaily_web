...
if (!empty($url_recargar) && !empty($url_codigo_planilla) && !empty($url_ano_generacion) && !empty($url_mes_generacion) ) {
    ...
    if ($tipo_planilla == '1'){
        ...
        //$periodo = "2-".$textos["PRIMERA_QUINCENA"]."|3-".$textos["SEGUNDA_QUINCENA"];
        $periodo = array(
            "2" => $textos["PRIMERA_QUINCENA"],
            "3" => $textos["SEGUNDA_QUINCENA"],
        );
    } else if($tipo_planilla == '3')  {
        //$periodo = "4-".$textos["PRIMERA_SEMANA"]."|5-".$textos["SEGUNDA_SEMANA"]."|5-".$textos["TERCERA_SEMANA"]."|7-".$textos["CUARTA_SEMANA"]."|8-".$textos["QUINTA_SEMANA"];
        $periodo = array(
...
if (!empty($url_generar)) {
    ...
    if (!$error_continuar){
        ...
        $formularios["PESTANA_BASICA"] = array(
            array(
                HTML::listaSeleccionSimple("*ano_generacion", $textos["ANO_GENERACION"],$ano_generacion,$ano, array("title" => $textos["AYUDA_ANO_GENERACION"], "class" => "selectorFecha", "onchange"=>"cargarFechaPago1();")),
                HTML::listaSeleccionSimple("*mes_generacion", $textos["MES_GENERACION"],$meses,$mes, array("title" => $textos["AYUDA_MES_GENERACION"], "class" => "selectorFecha", "onchange"=>"cargarFechaPago1();"))
            ),
            array(
            ...
            array(
                HTML::listaSeleccionSimple("codigo_planilla",$textos["PLANILLA"],$planillas,"",array("title"=>$textos["AYUDA_PLANILLA"], "onchange"=>"cargarFechaPago1();"))
            ),
            array(
                HTML::listaSeleccionSimple("fecha_pago",$textos["FECHA_PAGO"], "","",array("title"=>$textos["AYUDA_FECHA_PAGO"],"class"=>"fecha_pago")),
                HTML::listaSeleccionSimple("periodo",$textos["PERIODO"], "","",array("title"=>$textos["AYUDA_PERIODO"]))
            )
        );
