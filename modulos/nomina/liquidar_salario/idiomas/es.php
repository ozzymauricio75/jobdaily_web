...
$textos = array(
    ...
    "ANO_GENERACION"            => "Año",
    "AYUDA_ANO_GENERACION"      => "Seleccione el año de liquidación",
    "MES_GENERACION"            => "Mes",
    "AYUDA_MES_GENERACION"      => "Seleccione el mes de liquidación",
    ...
    "SALARIO_GENERADO"          => "Liquidación de salario generada satisfactoriamente",
