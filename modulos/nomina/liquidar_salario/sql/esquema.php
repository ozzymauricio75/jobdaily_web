...
$tablas["movimientos_salarios"] = array(
    ...
    "periodo_pago"                  => "ENUM('1','2','3','4','5','6','7','8') NOT NULL COMMENT '1->Mensual 2->Primera quincena 3->Segunda quincena 4->Primera semana 5->Segunda semana 6->Tercer semana 7->Cuarta semana 8->Quinta semana 9->Fecha unica'",
    ...
    "tabla_genera_movimiento"       => "VARCHAR(255) NULL COMMENT 'Nombre de la tabla de donde proviene el movimiento'",
    "llave_tabla_genera_movimiento" => "VARCHAR(255) NULL COMMENT 'Llave de la tabla de donde proviene el movimiento'",
    "contabilizado"                 => "ENUM('0','1') NOT NULL DEFAULT '0' COMMENT '0->No 1->Si 2->Leido para calcular salario'",
    "codigo_usuario_genera"         => "SMALLINT(4) UNSIGNED ZEROFILL  NOT NULL COMMENT 'Codigo usuario que genera el registro'"
);

$tablas["movimientos_auxilio_transporte"] = array(
    "codigo_sucursal"               => "MEDIUMINT(5) UNSIGNED ZEROFILL NOT NULL COMMENT 'Codigo del almacen donde va a laborar'",
...
$llavesPrimarias["movimientos_salarios"] = "codigo_sucursal,ano_generacion,mes_generacion,codigo_planilla,periodo_pago,codigo_transaccion_contable,consecutivo";
$llavesPrimarias["movimientos_auxilio_transporte"] = "codigo_sucursal,ano_generacion,mes_generacion,codigo_planilla,periodo_pago,codigo_transaccion_contable,consecutivo";

// Definici{on de llaves Foraneas
$llavesForaneas["movimientos_salarios"] = array(
    array(
        // Nombre de la llave foranea
        "movimiento_salario_sucursal_contrato",
    ...
    array(
        // Nombre de la llave foranea
        "movimiento_salario_codigo_planilla",
        // Nombre del campo en la tabla actual
        "codigo_planilla",
        // Nombre de la tabla relacionada
        "planillas",
    ...
    array(
        // Nombre de la llave foranea
        "movimiento_salario_transaccion_contable",
        // Nombre del campo en la tabla actual
    ...
    array(
        // Nombre de la llave foranea
        "movimiento_salario_transaccion_tiempo",
        // Nombre del campo en la tabla actual
    ...
    array(
        // Nombre de la llave foranea
        "movimiento_salario_auxiliar_contable",
        // Nombre del campo en la tabla actual
    ...
    array(
        // Nombre de la llave foranea
        "movimiento_salario_plan_contable",
        // Nombre del campo en la tabla actual
        "codigo_contable",
        // Nombre de la tabla relacionada
        "plan_contable",
...
$llavesForaneas["movimientos_auxilio_transporte"] = array(
    array(
        // Nombre de la llave foranea
        "movimiento_auxilio_sucursal_contrato",
        // Nombre del campo en la tabla actual
        "codigo_empresa,documento_identidad_empleado,fecha_ingreso_empresa,codigo_sucursal,fecha_ingreso_sucursal",
        // Nombre de la tabla relacionada
        "sucursal_contrato_empleados",
    ...
    array(
        // Nombre de la llave foranea
        "movimiento_auxilio_codigo_planilla",
        // Nombre del campo en la tabla actual
        "codigo_planilla",
        // Nombre de la tabla relacionada
        "planillas",
    ...
    array(
        // Nombre de la llave foranea
        "movimiento_auxilio_transaccion_contable",
        // Nombre del campo en la tabla actual
        "codigo_transaccion_contable",
        // Nombre de la tabla relacionada
        "transacciones_contables_empleado",
    ...
    array(
        // Nombre de la llave foranea
        "movimiento_auxilio_transaccion_tiempo",
        // Nombre del campo en la tabla actual
        "codigo_transaccion_tiempo",
        // Nombre de la tabla relacionada
        "transacciones_tiempo",
    ...
    array(
        // Nombre de la llave foranea
        "movimiento_auxilio_auxiliar_contable",
        // Nombre del campo en la tabla actual
        "codigo_empresa_auxiliar,codigo_anexo_contable,codigo_auxiliar_contable",
        // Nombre de la tabla relacionada
        "auxiliares_contables",
    ...
    array(
        // Nombre de la llave foranea
        "movimiento_auxilio_plan_contable",
        // Nombre del campo en la tabla actual
        "codigo_contable",
        // Nombre de la tabla relacionada
        "plan_contable",
...
$registros["componentes"] = array(
    array(
        ...
        "orden"         => "10",
        "visible"       => "1",
        "carpeta"       => "liquidar_salario",
        "global"        => "0",
        "archivo"       => "liquidar_salario",
        "requiere_item" => "0",
        "tipo_enlace"   => "2"
    )
);
