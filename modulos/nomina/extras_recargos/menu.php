...
$vistaMenu     = "menu_movimiento_tiempos_laborados";
$vistaBuscador = "buscador_movimiento_tiempos_laborados";
...
$botones  = HTML::boton("ADICEXRE",$textos["ADICIONAR"],"ejecutarComando(this,700,450);","adicionar");
$botones .= HTML::boton("CONSEXRE",$textos["CONSULTAR"],"ejecutarComando(this,550,350);","consultar");
$botones .= HTML::boton("MODIEXRE",$textos["MODIFICAR"],"ejecutarComando(this,700,450);","modificar");
$botones .= HTML::boton("ELIMEXRE",$textos["ELIMINAR"],"ejecutarComando(this,550,350);","eliminar");
$botones .= HTML::boton("LISTEXRE",$textos["EXPORTAR"],"ejecutarComando(this,550,350);","exportar");
