...
ALTER TABLE `job_movimiento_tiempos_laborados` CHANGE `fecha_generacion` `fecha_generacion` DATETIME NOT NULL COMMENT 'Fecha en la segenero el movimiento de tiempo'
