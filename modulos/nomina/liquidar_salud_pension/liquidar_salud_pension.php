            ...
            if($contadorNO>0){
                ...
                foreach ($forma_sucursales AS $codigo_sucursal) {
                    ...
                    $columnas = array(
                        ...
                        "ibc_salud",
                        "sentido",
                        "SUM(valor_movimiento) AS valor_movimiento"
                    );

                    $agrupamiento = "codigo_sucursal,documento_identidad_empleado,sentido,ibc_salud";
                    $ordenamiento = "codigo_sucursal,documento_identidad_empleado,sentido";

                    $consultaMS = SQL::seleccionar(array("consulta_datos_planilla"),$columnas,"ano_generacion='$forma_ano_generacion' AND mes_generacion='$forma_mes_generacion' AND codigo_planilla='$forma_codigo_planilla' AND periodo_pago='$forma_periodo' AND codigo_sucursal='$codigo_sucursal' AND contabilizado != '1' AND (ibc_salud='1' OR ibc_salud='2')",$agrupamiento,$ordenamiento);
                    ...
                    if(SQL::filasDevueltas($consultaMS)){//Si existen movimientos en esta sucursal para esta planilla en esta tabla entonces siga
                        ...
                        while($datosMS = SQL::filaEnObjeto($consultaMS)){
                            ...
                            if (!isset($documento_empleado[$datosMS->documento_identidad_empleado])){
                                $documento_empleado[$datosMS->documento_identidad_empleado] = $datosMS->documento_identidad_empleado;
                            }

                            if (!isset($entidad[$datosMS->documento_identidad_empleado])){

                                if (!isset($forma_descuento_salud[$datosMS->documento_identidad_empleado])){

                                    $consulta_contrato = SQL::seleccionar(array("consulta_contrato_empleado"),array("*"),"documento_identidad_empleado='$datosMS->documento_identidad_empleado' AND codigo_sucursal='$codigo_sucursal' AND fecha_ingreso_sucursal <= '$forma_fecha_pago' AND IF(fecha_retiro_sucursal != '0000-00-00',fecha_retiro_sucursal >= '$forma_fecha_pago',fecha_retiro_sucursal = '0000-00-00') AND estado = 1");

                                    $datos_contrato = SQL::filaEnObjeto($consulta_contrato);

                                    $forma_descuento_salud[$datosMS->documento_identidad_empleado]    = $datos_contrato->forma_descuento_salud;
                                    $codigo_transaccion_salud[$datosMS->documento_identidad_empleado] = $datos_contrato->codigo_transaccion_salud;
                                    $codigo_empresa[$datosMS->documento_identidad_empleado]           = $datos_contrato->codigo_empresa;
                                    $fecha_ingreso_empresa[$datosMS->documento_identidad_empleado]    = $datos_contrato->fecha_ingreso;
                                    $fecha_ingreso_sucursal[$datosMS->documento_identidad_empleado]   = $datos_contrato->fecha_ingreso_sucursal;
                                    $codigo_empresa_auxiliar[$datosMS->documento_identidad_empleado]  = $datos_contrato->codigo_empresa_auxiliar;
                                    $codigo_anexo_contable[$datosMS->documento_identidad_empleado]    = $datos_contrato->codigo_anexo_contable;
                                    $codigo_auxiliar[$datosMS->documento_identidad_empleado]          = $datos_contrato->codigo_auxiliar;
                                    $salario[$datosMS->documento_identidad_empleado]                  = $datos_contrato->salario;

                                    $codigo_contable[$datosMS->documento_identidad_empleado] = SQL::obtenerValor("transacciones_contables_empleado","codigo_contable","codigo='$datos_contrato->codigo_transaccion_salud'");
                                    $sentido[$datosMS->documento_identidad_empleado] = SQL::obtenerValor("transacciones_contables_empleado","sentido","codigo='$datos_contrato->codigo_transaccion_salud'");
                                }

                                $entidad[$datosMS->documento_identidad_empleado] = SQL::obtenerValor("entidades_salud_empleados","codigo_entidad_salud","documento_identidad_empleado='$datosMS->documento_identidad_empleado' AND codigo_empresa='$datosMS->codigo_empresa' AND fecha_ingreso='".$fecha_ingreso_empresa[$datosMS->documento_identidad_empleado]."' AND fecha_inicio_salud <= '$forma_fecha_pago' ORDER BY fecha_inicio_salud DESC LIMIT 0,1");
                            }
                            ...
                            if(isset($entidad[$datosMS->documento_identidad_empleado])){
                                ...
                                if(
                                   (
                                    ($forma_periodo == '2' || $forma_periodo == '3') && $forma_descuento_salud[$datosMS->documento_identidad_empleado] == '1'
                                   )||
                                   ($forma_periodo == '3' && $forma_descuento_salud[$datosMS->documento_identidad_empleado] == '2')||
                                   ($forma_periodo != '2' && $forma_periodo != '3')
                                  ){

                                      echo var_dump("Forma periodo");

                                    if($datosMS->ibc_salud == "1"){
                                        if(isset($base_empleado[$datosMS->documento_identidad_empleado])){

                                            if($datosMS->sentido == 'D'){
                                                $base_empleado[$datosMS->documento_identidad_empleado] += $datosMS->valor_movimiento;
                                            ...
                                            if($datosMS->sentido == 'D'){
                                                ...
                                                $base_empleado[$datosMS->documento_identidad_empleado] = (-1)*$datosMS->valor_movimiento;
                                            }
                                        }
                                echo var_dump("2 base_empleado ".$datosMS->documento_identidad_empleado);
                                echo var_dump($datosMS->valor_movimiento);
                                echo var_dump($base_empleado[$datosMS->documento_identidad_empleado]);
                                    } else if($datosMS->ibc_salud == "2"){// Si tiene marca 40%

                                        if(isset($base_empleado40[$datosMS->documento_identidad_empleado])){

                                            if($datosMS->sentido == 'D'){
                                                $base_empleado40[$datosMS->documento_identidad_empleado] += $datosMS->valor_movimiento;
                                            }else if($datosMS->sentido == 'C'){
                                                $base_empleado40[$datosMS->documento_identidad_empleado] -= $datosMS->valor_movimiento;
                                            }
                                        }else{
                                            ...
                                            if($datosMS->sentido == 'D'){
                                                ...
                                                $base_empleado40[$datosMS->documento_identidad_empleado] = (-1)*$datosMS->valor_movimiento;
                                            }
                                        }
                                echo var_dump("2 base_empleado 40".$datosMS->documento_identidad_empleado);
                                echo var_dump($base_empleado[$datosMS->documento_identidad_empleado]);
                                    }

                                    if($forma_periodo == "3" && $forma_descuento_salud[$datosMS->documento_identidad_empleado] == "2" && !isset($primer_periodo[$datosMS->documento_identidad_empleado])){//Para cuando el pago de salud se efectua en segunda quincena mirar movimientos pendientes de la primera quincena pa acumular en el ibc
                                        foreach($sucursales AS $codigo_sucursal_periodo2){
                                            $sucursales_consulta = $codigo_sucursal_periodo2.",";
                                        }
                                        $sucursales_consulta = trim($sucursales_consulta,",");
                                        ...
                                        $condicion    .= " AND codigo_planilla='$forma_codigo_planilla' AND periodo_pago='2'";
                                        $condicion    .= " AND codigo_sucursal IN('$sucursales_consulta') AND contabilizado != '1'";
                                        $condicion    .= " AND (ibc_salud='1' OR ibc_salud='2')";
                                        $condicion    .= " AND documento_identidad_empleado='$datosMS->documento_identidad_empleado'";
                                        $consulta_periodo2 = SQL::seleccionar(
                                            array("consulta_datos_planilla"),
                                            $columnas,
                                            $condicion,
                                            $agrupamiento,
                                            $ordenamiento
                                        ...
                                        if(SQL::filasDevueltas($consulta_periodo2)){
                                            $primer_periodo[$datosMS->documento_identidad_empleado] = true;
                                            while($datos_periodo2 = SQL::filaEnObjeto($consulta_periodo2)){

                                                if($datos_periodo2->ibc_salud == "1"){
                                                    if(isset($base_empleado[$datosMS->documento_identidad_empleado])){

                                                        if($datos_periodo2->sentido == 'D'){
                                                            $base_empleado[$datosMS->documento_identidad_empleado] += $datos_periodo2->valor_movimiento;
                                                        }else if($datos_periodo2->sentido == 'C'){
                                                            $base_empleado[$datosMS->documento_identidad_empleado] -= $datos_periodo2->valor_movimiento;
                                                        }
                                                    }else{
                                                        ...
                                                        if($datos_periodo2->sentido == 'D'){
                                                            ...
                                                            $base_empleado[$datosMS->documento_identidad_empleado] = (-1)*$datos_periodo2->valor_movimiento;
                                                        }
                                                    }
                                    echo var_dump("1 base_empleado ".$datosMS->documento_identidad_empleado);
                                    echo var_dump($datos_periodo2->valor_movimiento);
                                    echo var_dump($base_empleado[$datosMS->documento_identidad_empleado]);
                                                } else if($datosMS->ibc_salud == "2"){// Si tiene marca 40%
                                    ...
                                    echo var_dump("1 base_empleado40 ".$datosMS->documento_identidad_empleado);
                                    echo var_dump($base_empleado40[$datosMS->documento_identidad_empleado]);
                                                }
                                            }
                                        }
                                    }
                        ...
                        echo var_dump($documento_empleado);

                        foreach($documento_empleado AS $documento_identidad_empleado){

                            if($forma_periodo == '3' && $forma_descuento_salud[$documento_identidad_empleado] == '2'){
                                $dias_trabajados[$documento_identidad_empleado] = SQL::obtenerValor("movimientos_salarios","SUM(dias_trabajados)","ano_generacion='$forma_ano_generacion' AND mes_generacion='$forma_mes_generacion' AND codigo_planilla='$forma_codigo_planilla' AND codigo_sucursal='$codigo_sucursal' AND documento_identidad_empleado='$documento_identidad_empleado'");
                            }else{
                                $dias_trabajados[$documento_identidad_empleado] = SQL::obtenerValor("movimientos_salarios","SUM(dias_trabajados)","ano_generacion='$forma_ano_generacion' AND mes_generacion='$forma_mes_generacion' AND codigo_planilla='$forma_codigo_planilla' AND periodo_pago='$forma_periodo' AND codigo_sucursal='$codigo_sucursal' AND documento_identidad_empleado='$documento_identidad_empleado'");
                            }
                            ...
                            if(!$dias_trabajados){
                                ...
                                if($forma_periodo == '1'){
                                    ...
                                    $dias_trabajados[$documento_identidad_empleado] = 30 - $dias_incapacidad - $dias_no_laborados;

                                }elseif($forma_periodo == '2' && $forma_descuento_salud[$documento_identidad_empleado] == '1'){

                                    $dias_incapacidad  = SQL::obtenerValor("reporte_incapacidades","COUNT(fecha_incapacidad)","ano_generacion='$forma_ano_generacion' AND mes_generacion='$forma_mes_generacion' AND codigo_planilla='$forma_codigo_planilla' AND periodo_pago='$forma_periodo' AND codigo_sucursal='$codigo_sucursal' AND documento_identidad_empleado='$documento_identidad_empleado'");

                                    $dias_no_laborados = SQL::obtenerValor("movimiento_tiempos_no_laborados_dias","COUNT(fecha_inicio_tiempo)","ano_generacion='$forma_ano_generacion' AND mes_generacion='$forma_mes_generacion' AND codigo_planilla='$forma_codigo_planilla' AND periodo_pago='$forma_periodo' AND codigo_sucursal='$codigo_sucursal' AND documento_identidad_empleado='$documento_identidad_empleado'");

                                    $dias_trabajados[$documento_identidad_empleado] = 15 - $dias_incapacidad - $dias_no_laborados;

                                }elseif($forma_periodo == '3'){

                                    if($forma_descuento_salud[$documento_identidad_empleado] == "1"){
                                        ...
                                        $dias_incapacidad  = SQL::obtenerValor("reporte_incapacidades","COUNT(fecha_incapacidad)","ano_generacion='$forma_ano_generacion' AND mes_generacion='$forma_mes_generacion' AND codigo_planilla='$forma_codigo_planilla' AND codigo_sucursal='$codigo_sucursal' AND documento_identidad_empleado='$documento_identidad_empleado'");
                            ...
                            if(isset($base_empleado[$documento_identidad_empleado])){

                                $ibc = $base_empleado[$documento_identidad_empleado];

                                if(isset($base_empleado40[$documento_identidad_empleado])){

                                    $basecon40       = $base_empleado[$documento_identidad_empleado] + $base_empleado40[$documento_identidad_empleado];
                                    $valor40debase40 = ($basecon40 * 40)/100;

                                    if($base_empleado40[$documento_identidad_empleado] >= $valor40debase40){
                                        $ibc += $base_empleado40[$documento_identidad_empleado];
                                    }
                                }

                                $valor_movimiento     = round(($ibc*$porcentajeSalud)/100);

                                    $codigo_transaccion_contable = $codigo_transaccion_salud[$documento_identidad_empleado];
                                    $codigo_empresa_empleado     = $codigo_empresa[$documento_identidad_empleado];
                                    $fecha_ingreso               = $fecha_ingreso_empresa[$documento_identidad_empleado];
                                    $fecha_sucursal              = $fecha_ingreso_sucursal[$documento_identidad_empleado];
                                    $codigo_empresa_auxiliar_contable     = $codigo_empresa_auxiliar[$documento_identidad_empleado];
                                    $codigo_anexo                = $codigo_anexo_contable[$documento_identidad_empleado];
                                    $codigo_auxiliar_contable    = $codigo_auxiliar[$documento_identidad_empleado];
                                    $codigo_entidad_salud        = $entidad[$documento_identidad_empleado];
                                    $codigo_contable_movimiento  = $codigo_contable[$documento_identidad_empleado];
                                    $sentido_transaccion         = $sentido[$documento_identidad_empleado];
                                    $salario_empleado            = $salario[$documento_identidad_empleado];
                                ...
                                $datos = array(
                                    ...
                                    ///////////////////////////////
                                    "codigo_empresa_auxiliar"       => $codigo_empresa_auxiliar_contable,
                                    "codigo_anexo_contable"         => $codigo_anexo,
                                    "codigo_auxiliar_contable"      => $codigo_auxiliar_contable,
                                    ///////////////////////////////
                                    "codigo_entidad_salud"          => $codigo_entidad_salud,
                                    ///////////////////////////////
                                    "codigo_contable"               => $codigo_contable_movimiento,
                                    "sentido"                       => $sentido_transaccion,
                                ...
                                $existe = SQL::existeItem("movimientos_salud","documento_identidad_empleado",$documento_identidad_empleado,"ano_generacion='$forma_ano_generacion' AND mes_generacion='$forma_mes_generacion' AND codigo_planilla='$forma_codigo_planilla' AND periodo_pago='$forma_periodo' AND codigo_sucursal='$codigo_sucursal'");
                    ...
                    }// Fin consulta movimientos ibc_salud=1 ó ibc_salud=2
                }
                                    ...
                                    if(SQL::filasDevueltas($consulta)){//Si esta dentro de una sucursal en esa fecha y esta activo siga
                                        ...
                                        ($forma_periodo == '3' && $datosSCE->forma_descuento_pension == '2')||($forma_periodo != '2' && $forma_periodo != '3')){
                                            ...
                                            if($estado_ibc_pension == '1'){// Si tiene marca si
                                                ...
                                                if(isset($base_empleado[$datosMS->documento_identidad_empleado][$codigo_sucursal])){

                                                    if($datosMS->sentido == 'D'){
                                                        $base_empleado[$datosMS->documento_identidad_empleado][$codigo_sucursal]+=$datosMS->valor_movimiento;
                                                    }else if($datosMS->sentido == 'C'){
                                                        $base_empleado[$datosMS->documento_identidad_empleado][$codigo_sucursal]-= $datosMS->valor_movimiento;
                                                    }
                                                }else{
                                                    ...
                                                    if($datosMS->sentido == 'D'){
                                                        ...
                                                        $base_empleado[$datosMS->documento_identidad_empleado][$codigo_sucursal] = (-1)*$datosMS->valor_movimiento;
                                                    }
                                                }
                                                ...
                                                if(isset($base_empleado40[$datosMS->documento_identidad_empleado][$codigo_sucursal])){

                                                    if($datosMS->sentido == 'D'){
                                                        $base_empleado40[$datosMS->documento_identidad_empleado][$codigo_sucursal]+=$datosMS->valor_movimiento;
                                                    }else if($datosMS->sentido == 'C'){
                                                        $base_empleado40[$datosMS->documento_identidad_empleado][$codigo_sucursal]-= $datosMS->valor_movimiento;
                                                    }
                                                }else{
                                                    ...
                                                    if($datosMS->sentido == 'D'){
                                                        ...
                                                        $base_empleado40[$datosMS->documento_identidad_empleado][$codigo_sucursal] = (-1)*$datosMS->valor_movimiento;
                                                    }
                                                }
                ...
                foreach($id_empleados AS $id){
                    ...
                    foreach ($forma_sucursales AS $codigo_sucursal) {
                        ...
                        if(SQL::filasDevueltas($consulta)){
                                    ...
                                    while($datosMS = SQL::filaEnObjeto($consultaMS)){
                                        ...
                                        if(SQL::filasDevueltas($consultaCCE)){
                                            ...
                                            if($ibc_pension == '1'){// Si tiene marca si
                                                ...
                                                if(isset($base_empleado[$id][$codigo_sucursal])){

                                                    if($datosMS->sentido == 'D'){
                                                        $base_empleado[$id][$codigo_sucursal]+=$datosMS->valor_movimiento;
                                                    }else if($datosMS->sentido == 'C'){
                                                        $base_empleado[$id][$codigo_sucursal]-= $datosMS->valor_movimiento;
                                                    }
                                                }else{
                                                    ...
                                                    if($datosMS->sentido == 'D'){
                                                        ...
                                                        $base_empleado[$id][$codigo_sucursal] = (-1)*$datosMS->valor_movimiento;
                                                    }
                                                }
                                            }else if($estado_ibc_pension == '2'){// Si tiene marca 40%

                                                if(isset($base_empleado40[$id][$codigo_sucursal])){

                                                    if($datosMS->sentido == 'D'){
                                                        $base_empleado40[$id][$codigo_sucursal]+=$datosMS->valor_movimiento;
                                                    }else if($datosMS->sentido == 'C'){
                                                        $base_empleado40[$id][$codigo_sucursal]-= $datosMS->valor_movimiento;
                                                    }
                                                }else{
                                                    ...
                                                    if($datosMS->sentido == 'D'){
                                                        ...
                                                        $base_empleado40[$id][$codigo_sucursal] = (-1)*$datosMS->valor_movimiento;
                                                    }
                                                }
                                            }
                                        }
                            ...
                            if(!isset($base_empleado[$id][$codigo_sucursal])){
                                $base_empleado[$id][$codigo_sucursal] = 0;
                            }

                            $ibc = $base_empleado[$id][$codigo_sucursal];

                            if(isset($base_empleado40[$id][$codigo_sucursal])){
                                $basecon40       = $base_empleado[$id][$codigo_sucursal] + $base_empleado40[$id][$codigo_sucursal];
                                $valor40debase40 = ($basecon40 * 40)/100;

                                if($base_empleado40[$id][$codigo_sucursal] >= $valor40debase40){
                                    $ibc += $base_empleado40[$id][$codigo_sucursal];
                                }
                            }
