...
$vistaMenu     = "menu_fechas_planillas";
$vistaBuscador = "buscador_fechas_planillas";
$alineacion    = array("I","C");
...
$botones  = HTML::boton("ADICFEPL",$textos["ADICIONAR"],"ejecutarComando(this,450,400);","adicionar");
$botones .= HTML::boton("CONSFEPL",$textos["CONSULTAR"],"ejecutarComando(this,450,400);","consultar");
$botones .= HTML::boton("MODIFEPL",$textos["MODIFICAR"],"ejecutarComando(this,500,400);","modificar");
$botones .= HTML::boton("ELIMFEPL",$textos["ELIMINAR"],"ejecutarComando(this,410,300);","eliminar");
