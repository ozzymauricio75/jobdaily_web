...
$vistaMenu     = "menu_entidades_parafiscales";
$vistaBuscador = "buscador_entidades_parafiscales";
...
$botones  = HTML::boton("ADICENPF",$textos["ADICIONAR"],"ejecutarComando(this,500,400);","adicionar");
$botones .= HTML::boton("CONSENPF",$textos["CONSULTAR"],"ejecutarComando(this,500,400);","consultar");
$botones .= HTML::boton("MODIENPF",$textos["MODIFICAR"],"ejecutarComando(this,500,400);","modificar");
$botones .= HTML::boton("ELIMENPF",$textos["ELIMINAR"],"ejecutarComando(this,500,400);","eliminar");
$botones .= HTML::boton("LISTENPF",$textos["EXPORTAR"],"ejecutarComando(this,500,420);","exportar");
