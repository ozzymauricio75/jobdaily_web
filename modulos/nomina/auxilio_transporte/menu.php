...
$vistaMenu     = "menu_auxilio_transporte";
$vistaBuscador = "buscador_auxilio_transporte";
$alineacion    = array("I","C","D");
...
$botones  = HTML::boton("ADICAXTP",$textos["ADICIONAR"],"ejecutarComando(this,250,300);","adicionar");
$botones .= HTML::boton("CONSAXTP",$textos["CONSULTAR"],"ejecutarComando(this,290,290);","consultar");
$botones .= HTML::boton("MODIAXTP",$textos["MODIFICAR"],"ejecutarComando(this,300,300);","modificar");
$botones .= HTML::boton("ELIMAXTP",$textos["ELIMINAR"],"ejecutarComando(this,290,290);","eliminar");
