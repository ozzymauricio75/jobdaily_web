...
$vistaMenu     = "menu_deportes";
$vistaBuscador = "buscador_deportes";
...
$botones  = HTML::boton("ADICDEPO",$textos["ADICIONAR"],"ejecutarComando(this,380,260);","adicionar");
$botones .= HTML::boton("CONSDEPO",$textos["CONSULTAR"],"ejecutarComando(this,380,250);","consultar");
$botones .= HTML::boton("MODIDEPO",$textos["MODIFICAR"],"ejecutarComando(this,380,260);","modificar");
$botones .= HTML::boton("ELIMDEPO",$textos["ELIMINAR"],"ejecutarComando(this,380,260);","eliminar");
