...
if(isset($url_verificaAnexos)){
    ...
    $anexo    = SQL::obtenerValor("consulta_contrato_empleado","codigo_anexo_contable","documento_identidad_empleado='$url_empleado' AND codigo_sucursal='$url_sucursal' AND fecha_ingreso_sucursal <= '$url_fecha_inicial' AND estado='1' ORDER BY fecha_ingreso_sucursal DESC LIMIT 0,1");
        ...
        $formularios["PESTANA_BASICA"] = array(
               array(
                    ...
                    .HTML::campoOculto("codigo_sucursal2",$sesion_sucursal),
                     HTML::campoTextoCorto("*selector1", $textos["EMPLEADO"], 45, 255, "", array("title" => $textos["AYUDA_EMPLEADO"], "onFocus" => "acLocalEmpleados(this)","onKeyUp" => "limpiar_oculto_Autocompletable(this,documento_aspirante)"))
                ...
                array(
                    ...
                    HTML::campoTextoCorto("*fecha_inicial", $textos["FECHA_INICIAL"], 10, 10, date("Y-m-d"), array("title" => $textos["AYUDA_FECHA_INICIAL"], "class" => "selectorFecha")),
                    HTML::campoTextoCorto("*dias_no_laborados", $textos["CANTIDAD_DIAS"], 2, 3, "", array("title" => $textos["AYUDA_CANTIDAD_DIAS"], "onKeyPress" => "return campoEntero(event)")),
    ...
    if (!isset($forma_fechas_tiempo)){
        ...
        $fecha_registro = date("Y-m-d H:i:s");
         ...
         for($id = 0;!empty($forma_fechas_tiempo[$id]); $id++){
            ...
            $anexo    = $datos_sucursal_contrato->codigo_anexo_contable;
