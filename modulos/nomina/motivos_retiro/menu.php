...
$vistaMenu     = "menu_motivos_retiro";
$vistaBuscador = "buscador_motivos_retiro";
...
$botones  = HTML::boton("ADICMORE",$textos["ADICIONAR"],"ejecutarComando(this,410,340);","adicionar");
$botones .= HTML::boton("CONSMORE",$textos["CONSULTAR"],"ejecutarComando(this,410,250);","consultar");
$botones .= HTML::boton("MODIMORE",$textos["MODIFICAR"],"ejecutarComando(this,410,340);","modificar");
$botones .= HTML::boton("ELIMMORE",$textos["ELIMINAR"],"ejecutarComando(this,410,250);","eliminar");
