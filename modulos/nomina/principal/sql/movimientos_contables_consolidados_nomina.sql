-- Vista general de movimientos contables provenientes solo de la nomina --
...
--      - llave_registro              --
    ...
    CREATE OR REPLACE ALGORITHM = MERGE VIEW job_movimientos_contables_consolidados_nomina AS
    (
