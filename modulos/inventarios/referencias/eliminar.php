...
if (!empty($url_generar)) {
    ...
    if (empty($url_id)) {
        ...
        $formularios["PESTANA_GENERAL"] = array(
            ...
            array(
                HTML::mostrarDato("nombre_proveedor", $textos["DOCUMENTO_PROVEEDOR"], $datos->proveedor)
            ),
            array(
...
/*** Eliminar el elemento seleccionado ***/
    ...
    $consulta = SQL::eliminar("referencias_por_proveedor", "codigo_interno_articulo = '".$llave_principal[0]."' AND referencia = '".$llave_principal[1]."'");
