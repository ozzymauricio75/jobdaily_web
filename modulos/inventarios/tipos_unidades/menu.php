...
$vistaMenu     = "menu_tipos_unidades";
$vistaBuscador = "buscador_tipos_unidades";
...
$botones  = HTML::boton("ADICTIUN",$textos["ADICIONAR"],"ejecutarComando(this,330,280);","adicionar");
$botones .= HTML::boton("CONSTIUN",$textos["CONSULTAR"],"ejecutarComando(this,300,230);","consultar");
$botones .= HTML::boton("MODITIUN",$textos["MODIFICAR"],"ejecutarComando(this,330,280);","modificar");
$botones .= HTML::boton("ELIMTIUN",$textos["ELIMINAR"],"ejecutarComando(this,330,230);","eliminar");
...
$agrupamiento   = "";
$ordenamiento   = SQL::ordenColumnas("codigo");
