...
$vistaMenu     = "menu_grupos";
$vistaBuscador = "buscador_grupos";
...
$botones  = HTML::boton("ADICGRUP",$textos["ADICIONAR"],"ejecutarComando(this,340,320);","adicionar");
$botones .= HTML::boton("CONSGRUP",$textos["CONSULTAR"],"ejecutarComando(this,300,270);","consultar");
$botones .= HTML::boton("MODIGRUP",$textos["MODIFICAR"],"ejecutarComando(this,340,320);","modificar");
$botones .= HTML::boton("ELIMGRUP",$textos["ELIMINAR"],"ejecutarComando(this,300,270);","eliminar");
