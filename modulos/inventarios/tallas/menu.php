...
$vistaMenu     = "menu_tallas";
$vistaBuscador = "buscador_tallas";
...
$botones  = HTML::boton("ADICTALL",$textos["ADICIONAR"],"ejecutarComando(this,380,330);","adicionar");
$botones .= HTML::boton("CONSTALL",$textos["CONSULTAR"],"ejecutarComando(this,380,330);","consultar");
$botones .= HTML::boton("MODITALL",$textos["MODIFICAR"],"ejecutarComando(this,380,330);","modificar");
$botones .= HTML::boton("ELIMTALL",$textos["ELIMINAR"],"ejecutarComando(this,380,330);","eliminar");
