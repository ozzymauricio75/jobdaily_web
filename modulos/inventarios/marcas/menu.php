...
$usuario_actual = $sesion_codigo_usuario;
$sucursal_actual = $sesion_sucursal_conexion;
$fecha_conexion_actual = $sesion_fecha_conexion;

$vistaMenu     = "menu_marcas";
$vistaBuscador = "buscador_marcas";
...
$botones  = HTML::boton("ADICMARC",$textos["ADICIONAR"],"ejecutarComando(this,350,310);","adicionar");
$botones .= HTML::boton("CONSMARC",$textos["CONSULTAR"],"ejecutarComando(this,340,280);","consultar");
$botones .= HTML::boton("MODIMARC",$textos["MODIFICAR"],"ejecutarComando(this,350,310);","modificar");
$botones .= HTML::boton("ELIMMARC",$textos["ELIMINAR"],"ejecutarComando(this,340,280);","eliminar");
