...
/*** Validar los datos provenientes del formulario ***/
    ...
    if ($url_item == "descripcion") {
        $existe = SQL::existeItem("marcas", "descripcion", $url_valor, "codigo != $url_id AND descripcion !=''");
...
/*** Modificar el elemento seleccionado ***/
    ...
    if(empty($forma_codigo)){
    ...
    }elseif($existe = SQL::existeItem("marcas", "codigo", $forma_codigo, "codigo != $forma_id")){
        $error   = true;
        $mensaje = $textos["ERROR_EXISTE_CODIGO"]; 
    
    }elseif($existe = SQL::existeItem("marcas", "descripcion", $forma_descripcion, "codigo != $forma_id")){
        $error   = true;
        ...
        $consulta = SQL::modificar("marcas", $datos, "codigo = '$forma_id'");
