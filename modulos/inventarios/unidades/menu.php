...
$vistaMenu     = "menu_unidades";
$vistaBuscador = "buscador_unidades";
...
$botones  = HTML::boton("ADICUNID",$textos["ADICIONAR"],"ejecutarComando(this,400,370);","adicionar");
$botones .= HTML::boton("CONSUNID",$textos["CONSULTAR"],"ejecutarComando(this,350,320);","consultar");
$botones .= HTML::boton("MODIUNID",$textos["MODIFICAR"],"ejecutarComando(this,400,360);","modificar");
$botones .= HTML::boton("ELIMUNID",$textos["ELIMINAR"],"ejecutarComando(this,350,330);","eliminar");
