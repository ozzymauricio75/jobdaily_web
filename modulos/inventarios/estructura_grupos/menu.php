...
$vistaMenu     = "menu_estructura_grupos";
$vistaBuscador = "buscador_estructura_grupos";
$alineacion    = array("C","I","I","I","D");
...
$botones  = HTML::boton("ADICESGR",$textos["ADICIONAR"],"ejecutarComando(this,500,520);","adicionar");
$botones .= HTML::boton("CONSESGR",$textos["CONSULTAR"],"ejecutarComando(this,470,550);","consultar");
$botones .= HTML::boton("MODIESGR",$textos["MODIFICAR"],"ejecutarComando(this,500,520);","modificar");
$botones .= HTML::boton("ELIMESGR",$textos["ELIMINAR"],"ejecutarComando(this,470,550);","eliminar");
...
$agrupamiento   = "";
$ordenamiento   = SQL::ordenColumnas("PADRE ASC");
