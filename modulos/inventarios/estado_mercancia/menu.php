...
$vistaMenu     = "menu_estado_mercancia";
$vistaBuscador = "buscador_estado_mercancia";
...
$botones  = HTML::boton("ADICESME",$textos["ADICIONAR"],"ejecutarComando(this,350,250);","adicionar");
$botones .= HTML::boton("CONSESME",$textos["CONSULTAR"],"ejecutarComando(this,300,250);","consultar");
$botones .= HTML::boton("MODIESME",$textos["MODIFICAR"],"ejecutarComando(this,350,250);","modificar");
$botones .= HTML::boton("ELIMESME",$textos["ELIMINAR"],"ejecutarComando(this,300,250);","eliminar");
