...
/*** Eliminar el elemento seleccionado ***/
    ...
    /*** Eliminar cuentas bancarias relacionadas con el proveedor ***/
    $consulta = SQL::seleccionar(array("cuentas_bancarias_proveedores"),array("*"),"documento_identidad_proveedor = '$forma_id'");
    ...
    if ($eliminar){
        $eliminar = SQL::eliminar("proveedores", "documento_identidad = '$forma_id'");

        if (!$eliminar){

            if (isset($codigo_banco)){

                foreach ($codigo_banco AS $indice => $valor){

                    $datos = array(                                
                        "documento_identidad_proveedor" => $forma_id,
                        "codigo_banco"                  => $valor,
                        "cuenta"                        => $cuenta[$indice],
                        "tipo_cuenta"                   => $tipo_cuenta[$indice]
                    );
