...
$botones  = HTML::boton("ADICPROV",$textos["ADICIONAR"],"ejecutarComando(this, 750, 600);","adicionar");
$botones .= HTML::boton("CONSPROV",$textos["CONSULTAR"],"ejecutarComando(this, 750, 600);","consultar");
$botones .= HTML::boton("MODIPROV",$textos["MODIFICAR"],"ejecutarComando(this, 750, 600);","modificar");
$botones .= HTML::boton("ELIMPROV",$textos["ELIMINAR"],"ejecutarComando(this, 750, 600);","eliminar");
