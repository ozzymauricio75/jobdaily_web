    ...
    if (empty($url_id)) {
        ...
        if (SQL::filasDevueltas($consulta)) {
            ...
            while ($datos = SQL::filaEnObjeto($consulta_documentos)) {
                ...
                if($estado_residente==1){
                    $estado = $textos["ESTADO_RESIDENTE_1"];
                }
        ...
        if (($datos_correspondencia->estado_director==0 && $datos_correspondencia->estado_residente==1)) {
            ...
            $formularios["PESTANA_GENERAL"] = array(
                ...
                array(
                        HTML::generarTabla(
                            array("id","BOTON_RECIBIR","FECHA_REGISTRO_RESIDENTE","NIT_PROVEEDOR","RAZON_SOCIAL","TIPO_DOCUMENTO","DOCUMENTO_SOPORTE","VALOR_DOCUMENTO","ESTADO_RESIDENTE"), 
                                $items, 
                                array("I","C","I","I","C","C","D","C"), 
                                "listaItems", 
                                false
                            )
                )
