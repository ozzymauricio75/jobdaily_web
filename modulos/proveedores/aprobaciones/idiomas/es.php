...
$textos = array(
    "GESTAPDO"                          => "Ingresar Facturas-Remision",
    "ADICAPRO"                          => "Adicionar Factura-Remision",
    "CONSAPRO"                          => "Consultar Factura-Remision",
    "MODIAPRO"                          => "Modificar Factura-Remision",
    "ANULAPRO"                          => "Anular Factura-Remision",
    "ELIMAPRO"                          => "Eliminar Factura-Remision",
    "APREAPRO"                          => "Aprobar Residente",
    "APDIAPRO"                          => "Aprobar Director",
    "IMPRIMIR_PDF"                      => "[Imprimir]",
    "CODIGO"                            => "Código",
    "FECHA_REGISTRO_RESIDENTE"          => "Fecha registro residente",
    "FECHA_REGISTRO_DIRECTOR"           => "Fecha registro director",
    "APROBAR_DIRECTOR"                  => "Aprobar director",
    "APROBAR_RESIDENTE"                 => "Aprobar residente",
    "TODOS"                             => "Todos",
    "TOTAL_ORDEN"                       => "Total orden",
    "TOTAL_CRUZADO"                     => "Total cruzado",
    "TOTAL_TOLERANCIA"                  => "Total tolerancia",
    ...
    "PESTANA_DOCUMENTO"                 => "Documento",
    "ESTADO_RESIDENTE"                  => "Estado residente",
    "ESTADO_DIRECTOR"                   => "Estado director",
    "RECIBIDO"                          => "Recibido",
    "ESTADO"                            => "Estado orden de compra",
    "ESTADO_CORRESPONDENCIA"            => "Estado",
    "ESTADO_RESIDENTE_0"                => "No aprobado",
    "ESTADO_RESIDENTE_1"                => "Aprobado",
    "ESTADO_RESIDENTE_2"                => "Anulado",
    "ESTADO_DIRECTOR_0"                 => "No aprobado",
    "ESTADO_DIRECTOR_1"                 => "Aprobado",
    "PROYECTO"                          => "Proyecto",
    "NIT_PROVEEDOR"                     => "Nit",
    ...
    "ITEM_RECIBIDO"                     => "El documento ha sido aprobado.",
    ...
    "ERROR_RECIBIR_ITEM"                => "No se pudo aprobar el documento",
    "ERROR_ELIMINAR_ITEM"               => "No se pudo eliminar el documento",
    "ERROR_ORDEN_ESTADO"                => "La operación no puede realizar debido a que el documento está aprobado o está anulado.",
    "ERROR_ORDEN_ESTADOS"               => "La operación no puede realizar debido a que el documento está aprobado o anulado o recibido.",
    ...
    "AYUDA_ARCHIVO_DOCUMENTO"           => "Seleccione el documento",
    "NOMBRE_DOCUMENTO"                  => "Nombre documento ",
    "AYUDA_NOMBRE_DOCUMENTO"            => "Titulo para el documento"
);
/*$textos = array(
    "GESTSUCU"                          => "Almacenes",
