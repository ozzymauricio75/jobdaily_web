...
if (!empty($url_generar)) {
    ...
    if (empty($url_id)) {
        ...
        if (SQL::filasDevueltas($consulta)) {
            ...
            $consulta_documentos = SQL::seleccionar(array("correspondencia"),array("*"),"codigo_proyecto='$datos_correspondencia->codigo_proyecto' AND documento_identidad_proveedor='$datos_correspondencia->documento_identidad_proveedor' AND estado_residente='0'");
