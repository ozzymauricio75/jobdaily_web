...
$tablas["ordenes_compra"] = array(
    ...
    "cantidad_registros"               => "INT(9) UNSIGNED ZEROFILL NOT NULL COMMENT 'Cantidad de Items para la propuesta de pedido'",
    "cantidad_cumplidos"               => "INT(9) UNSIGNED ZEROFILL NOT NULL COMMENT 'Cantidad de Items cumplidos en la propuesta de pedido'",
    ...
    "codigo_usuario_aprueba"           => "SMALLINT(4) UNSIGNED ZEROFILL NOT NULL COMMENT 'Id del usuario que aprueba la propuesta de pedido'",
    ...
    "observaciones"                    => "VARCHAR(234) COMMENT 'Observacion general para el pedido'",
    "imprimio"                         => "ENUM('0','1') NOT NULL DEFAULT '0' COMMENT 'La propuesta de pedido ya se impirmio 0->No 1->Si'",
...
$tablas["movimiento_ordenes_compra"] = array(
    ...
    "referencia_articulo"     => "VARCHAR(15) NOT NULL COMMENT 'Referencia del producto a realizar propuesta de pedido'",
    ...
    "valor_total"             => "DECIMAL(15,4) UNSIGNED  NOT NULL COMMENT 'Valor total del pedido del articulo'",
