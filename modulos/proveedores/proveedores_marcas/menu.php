...
$vistaMenu     = "menu_proveedores_marcas";
$vistaBuscador = "buscador_proveedores_marcas";
...
$botones  = HTML::boton("ADICPRMA",$textos["ADICIONAR"],"ejecutarComando(this,550,300);","adicionar");
$botones .= HTML::boton("CONSPRMA",$textos["CONSULTAR"],"ejecutarComando(this,550,300);","consultar");
$botones .= HTML::boton("MODIPRMA",$textos["MODIFICAR"],"ejecutarComando(this,550,300);","modificar");
$botones .= HTML::boton("ELIMPRMA",$textos["ELIMINAR"],"ejecutarComando(this,550,300);","eliminar");
