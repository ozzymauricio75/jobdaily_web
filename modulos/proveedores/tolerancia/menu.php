...
$vistaMenu     = "menu_tolerancia";
$vistaBuscador = "buscador_tolerancia";
$alineacion    = array("C","D");
...
$botones  = HTML::boton("ADICTOLE",$textos["ADICIONAR"],"ejecutarComando(this, 350, 280);","adicionar");
$botones .= HTML::boton("CONSTOLE",$textos["CONSULTAR"],"ejecutarComando(this, 350, 230);","consultar");
$botones .= HTML::boton("MODITOLE",$textos["MODIFICAR"],"ejecutarComando(this, 350, 280);","modificar");
$botones .= HTML::boton("ELIMTOLE",$textos["ELIMINAR"],"ejecutarComando(this, 350, 250);","eliminar");
