...
$vistaMenu     = "menu_plazos_pago_proveedores";
$vistaBuscador = "buscador_plazos_pago_proveedores";
$alineacion    = array("I","C","C","C","C");
...
$botones  = HTML::boton("ADICPPPR",$textos["ADICIONAR"],"ejecutarComando(this, 500, 440);","adicionar");
$botones .= HTML::boton("CONSPPPR",$textos["CONSULTAR"],"ejecutarComando(this, 430, 430);","consultar");
$botones .= HTML::boton("MODIPPPR",$textos["MODIFICAR"],"ejecutarComando(this, 500, 440);","modificar");
$botones .= HTML::boton("ELIMPPPR",$textos["ELIMINAR"],"ejecutarComando(this, 430, 430);","eliminar");
