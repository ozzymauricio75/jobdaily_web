...
$vistaMenu     = "menu_cargos_externos";
$vistaBuscador = "buscador_cargos_externos";
...
$botones  = HTML::boton("ADICCAPR",$textos["ADICIONAR"],"ejecutarComando(this,450,290);","adicionar");
$botones .= HTML::boton("CONSCAPR",$textos["CONSULTAR"],"ejecutarComando(this,380,250);","consultar");
$botones .= HTML::boton("MODICAPR",$textos["MODIFICAR"],"ejecutarComando(this,450,290);","modificar");
$botones .= HTML::boton("ELIMCAPR",$textos["ELIMINAR"],"ejecutarComando(this,380,250);","eliminar");
