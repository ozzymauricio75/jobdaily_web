...
if (!empty($url_generar)) {
    ...
    if (empty($url_id)) {
        ...
        $vistaConsulta = "buscador_cargos_externos";
        ...
        /*** Obtener valor ***/
        $interno = SQL::obtenerValor("cargos","interno","codigo = '$url_id'");
...
/*** Modificar el elemento seleccionado ***/
    ...
    }elseif($existe = SQL::existeItem("cargos", "codigo", $forma_codigo,"codigo !=$forma_id")){
	    $error   = true;
        $mensaje = $textos["ERROR_EXISTE_CODIGO"]; 
        
    }elseif($existe = SQL::existeItem("cargos", "nombre", $forma_nombre, "codigo !=$forma_id")){
	    $error   = true;
