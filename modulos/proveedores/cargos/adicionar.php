...
if (!empty($url_generar)) {
    ...
    $codigo = SQL::obtenerValor("cargos","MAX(codigo)","codigo>0");
    if ($codigo){
        $codigo++;
    } else {
        $codigo = 1;
...
/*** Validar los datos provenientes del formulario ***/
    ...
    if ($url_item == "codigo") {
        $existe = SQL::existeItem("cargos", "codigo", $url_valor,"codigo != '0'");
    ...
    /*** Validar nombre ***/
    if ($url_item == "nombre") {
        $existe = SQL::existeItem("cargos", "nombre", $url_valor,"nombre != ''");
...
/*** Procesar los datos del formulario ***/
    ...
    /*** Validar ingreso de los campos requeridos ***/
    ...
    }elseif($existe = SQL::existeItem("cargos", "codigo", $forma_codigo)){
	    $error   = true;
        $mensaje = $textos["ERROR_EXISTE_CODIGO"]; 
        
    }elseif($existe = SQL::existeItem("cargos", "nombre", $forma_nombre)){
	    $error   = true;
