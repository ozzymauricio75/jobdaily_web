...
$vistaMenu     = "menu_servicios";
$vistaBuscador = "buscador_servicios";
...
$botones  = HTML::boton("ADICSERV",$textos["ADICIONAR"],"ejecutarComando(this, 350, 280);","adicionar");
$botones .= HTML::boton("CONSSERV",$textos["CONSULTAR"],"ejecutarComando(this, 350, 230);","consultar");
$botones .= HTML::boton("MODISERV",$textos["MODIFICAR"],"ejecutarComando(this, 350, 280);","modificar");
$botones .= HTML::boton("ELIMSERV",$textos["ELIMINAR"],"ejecutarComando(this, 350, 250);","eliminar");
