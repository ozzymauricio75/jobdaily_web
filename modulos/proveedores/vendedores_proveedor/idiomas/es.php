...
$textos = array(
    "GESTVPRO"                              => "Vendedores proveedor",
    "ADICVDPR"                              => "Adicionar vendedor proveedor",
    "CONSVDPR"                              => "Consultar vendedor proveedor",
    "MODIVDPR"                              => "Modificar vendedor proveedor",
    "ELIMVDPR"                              => "Eliminar vendedor proveedor",
    "LISTCMPR"                              => "Listar compradores",
    "REPORTE_COMPRADORES"                   => "Listado de compradores",
    "PESTANA_PERSONAL"                      => "Localización",
    "PESTANA_VENDEDOR"                      => "Datos operativos",
    ...
    "ERROR_VENDEDOR_EXISTE"                 => "Error, Vendedor del porveedor ya existe, verifique",
