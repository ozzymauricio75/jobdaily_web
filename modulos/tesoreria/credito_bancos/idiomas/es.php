...
$textos = array(
    ...
    "FECHA_PAGO_CUOTA"              => "Dia pago cuota",
    "FECHA_PAGO"                    => "Fecha pago",
    "DIA_PAGO"                      => "Dia pago",
    "POR_ESTADO"                    => "Por estado",
    "ULTIMO_PAGADO"                 => "Ultimo pag",
    "PROXIMO_PAGO"                  => "Prox a pag",
    ...
    "FECHA_PAGO_VACIO"              => "Dia de pago vacio",
    ...
    "AYUDA_POR_ESTADO"              => "Estado del credito",
    "AYUDA_TIPO_CREDITO"            => "Seleccione el tipo de credito",
