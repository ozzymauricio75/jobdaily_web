...
$textos = array(
    ...
    "ADICCRBA"                      => "Adicionar credito banco",
    "CONSCRBA"                      => "Consultar credito banco",
    "MODICRBA"                      => "Modificar credito banco",
    "ELIMCRBA"                      => "Eliminar credito banco",
    "ANULCRBA"                      => "Anular credito banco",
    "REPOCRBA"                      => "Reporte de creditos bancos",
    "PIE_PAGINA_EMPRESA"            => "Documento impreso por: Jobdaily - Trabajo Diario.",
    "REPOMVTE"                      => "Reportes de movimientos tesoreria",
    "FECHA_DESDE_HASTA"             => "Fecha desde - hasta",
    "REPORTE"                       => "Reporte",
    "BANCOS"                        => "Bancos",
    "INTERES"                       => "Interes",
    "INTERES_PAGADO"                => "Interes Pag.",
    "NRO_CUOTA"                     => "Nro cuota",
    "ABONO_CAPITAL"                 => "Abono capital",
    "ABONO_CAPITAL_PAGADO"          => "Abono capit Pag.",
    "SALDO_CAPITAL_PAGADO"          => "Saldo capit Pag.",
    "ESTADO_CUOTA"                  => "Estado cuota",
    "CUENTAS"                       => "Cuentas",
    "SALDO"                         => "Saldo",
    "PROYECTO"                      => "Proyecto",
    "PROVEEDOR"                     => "Proveedor",
    "INTERES_POR_PAGAR"             => "Interes x pagar",
    "CAPITAL_POR_PAGAR"             => "Capital x pagar",
    "POR_PAGAR"                     => "Total por pagar",
    "CONCEPTO"                      => "Concepto",
    "TODOS_BANCOS"                  => "Todos los bancos",
    "DATOS_BANCO"                   => "Datos banco",
    "SALDOS_APROXIMADOS"            => "Saldos aproximados",
    "DATOS_CREDITO"                 => "Datos credito",
    "POR_BANCO"                     => "Por banco",
    ...
    "DEBITO"                        => "Debito",
    "CREDITO"                       => "Crédito",
    "PERIODOS"                      => "Número Cuotas",
    "PESTANA_CUOTAS"                => "Cuotas",
    ...
    "BANCO_VACIO"                   => "Nombre banco esta vacio",
    "VALOR_VACIO"                   => "Valor del movimiento vacio",
    "NUMERO_CUOTAS_VACIO"           => "Numero de cuotas vacio",
    "TASA_MENSUAL_VACIO"            => "Tasa mensual vacio",
    "NUMERO_CREDITO_VACIO"          => "Numero del credito vacio",
    "FECHA_VACIO"                   => "Fecha del movimiento vacio",
    "ITEM_ANULADO"                  => "Item anulado",
    "GENERAR_CUOTAS"                => "Adicionar cuotas",
    "MODIFICAR_CUOTAS"              => "Modificar cuotas",
    ...
    "AYUDA_VALOR_CREDITO"           => "Valor del credito al banco",
    "AYUDA_VALOR_CUOTA"             => "Valor de la cuota mensual",
    ...
    "AYUDA_TASA_MENSUAL"            => "Ayuda tasa mensual",
    ...
    "AYUDA_FECHA_CREDITO"           => "Fecha en la cual se realiza el movimiento",
    "AYUDA_NUMERO_CUENTA"           => "Numero de la cuenta bancaria",
    "AYUDA_NUMERO_CUOTAS"           => "Numero de cuotas del credito",
    "CREAR_GRUPOS_TESORERIA"        => "Error, debe existir grupos de tesoreria creados",
    "CREAR_BANCOS"                  => "Error, debe existir un banco creado",
