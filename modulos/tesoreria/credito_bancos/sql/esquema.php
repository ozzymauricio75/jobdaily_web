...
$tablas["creditos_bancos"]  = array(
    ...
    "tasa_mensual"                => "DECIMAL(2,2) UNSIGNED  NOT NULL COMMENT 'Porcentaje de tasa mensual'",
    "fecha_credito"               => "DATETIME NOT NULL COMMENT 'Fecha ingreso al sistema'",
...
$tablas["cuotas_creditos_bancos"] = array(
    ...
    "saldo_capital"               => "DECIMAL(15,2) UNSIGNED  NOT NULL COMMENT 'saldo capital del credito'",
    "saldo_capital_pagado"        => "DECIMAL(15,2) UNSIGNED  NOT NULL COMMENT 'saldo capital pagado del credito'",
    "observaciones"               => "VARCHAR(255) COMMENT 'Observacion general del credito'",
