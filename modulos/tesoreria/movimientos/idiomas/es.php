...
$textos = array(
    ...
    "CUENTA_DESTINO_PROPIA"         => "Cuenta destino propia",
    "CUENTA_DESTINO"                => "Cuenta destino",
    "CUENTA_DESTINO_PROVEEDOR"      => "Cuenta destino proveedor",
    ...
    "CREDITO_NO_EXISTE"             => "No existe credito",
    "CUENTA_VACIO"                  => "Número de cuenta esta vacio",
    "PROYECTO_VACIO"                => "Proyecto esta vacio",
    ...
    "AYUDA_NUMERO_CREDITO"          => "Seleccione el numero del credito",
    "AYUDA_VALOR_CREDITO"           => "Valor del credito",
    "AYUDA_BANCO"                   => "Banco al que pertenece la empresa",
    "AYUDA_IMPRIME_SALDOS"          => "Imprime el saldo de las cuentas",
