...
$botones  = HTML::boton("ADICMUNI",$textos["ADICIONAR"],"ejecutarComando(this, 360, 480);","adicionar");
$botones .= HTML::boton("CONSMUNI",$textos["CONSULTAR"],"ejecutarComando(this, 350, 400);","consultar");
$botones .= HTML::boton("MODIMUNI",$textos["MODIFICAR"],"ejecutarComando(this, 370, 480);","modificar");
$botones .= HTML::boton("ELIMMUNI",$textos["ELIMINAR"],"ejecutarComando(this, 350, 410);","eliminar");
$botones .= HTML::boton("LISTMUNI",$textos["EXPORTAR"],"ejecutarComando(this, 300, 300);","exportar");
