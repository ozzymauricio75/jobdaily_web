...
$botones  = HTML::boton("ADICTIDI",$textos["ADICIONAR"],"ejecutarComando(this,460,350);","adicionar");
$botones .= HTML::boton("CONSTIDI",$textos["CONSULTAR"],"ejecutarComando(this,380,270);","consultar");
$botones .= HTML::boton("MODITIDI",$textos["MODIFICAR"],"ejecutarComando(this,460,350);","modificar");
$botones .= HTML::boton("ELIMTIDI",$textos["ELIMINAR"],"ejecutarComando(this,380,270);","eliminar");
...
/*** Generar y enviar plantilla completa si la peticiòn no se realiza via AJAX ***/
