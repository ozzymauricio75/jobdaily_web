...
$tablas["preferencias"]   = array(
    ...
    "variable"         => "VARCHAR(255) NOT NULL COMMENT 'Nonbre de la preferencia'",
...
$vistas = array(
    array(
        "CREATE OR REPLACE ALGORITHM = MERGE VIEW job_menu_preferencias_usuario AS
        SELECT
            job_usuarios.codigo AS id,
            job_usuarios.nombre AS NOMBRE,
            job_usuarios.usuario AS USUARIO
        FROM
            job_usuarios
        WHERE
            job_usuarios.codigo > 0;"
    )
)
?>
