...
$vistas = array(
    array(
        "CREATE OR REPLACE ALGORITHM = MERGE VIEW job_menu_preferencias_empresas AS
        SELECT 
              job_menu_empresas.codigo AS id,
              job_menu_empresas.RAZON_SOCIAL
        FROM 
              job_menu_empresas;"
    )
);
