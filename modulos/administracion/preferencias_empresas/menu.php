...
$vistaMenu     = "menu_preferencias_empresas";
...
$botones = HTML::boton("MODIPREM",$textos["MODIFICAR"],"ejecutarComando(this, 1100, 550);","modificar");
...
$agrupamiento   = "";
$ordenamiento   = SQL::ordenColumnas("RAZON_SOCIAL ASC");
