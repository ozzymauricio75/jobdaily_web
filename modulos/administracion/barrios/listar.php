...
// Exportar los datos
    ...
    if ($tipo_listado == 1){
        ...
        $archivo->textoTitulo    = $textos["LISTBARR"];
        ...
        $tituloColumnas = array($textos["NOMBRE"],$textos["PAIS"],$textos["DEPARTAMENTO"],$textos["MUNICIPIO"],$textos["COMUNA"],$textos["ESTRATO"]);
        $anchoColumnas  = array(40,40,40,40,20,16);
        $archivo->generarCabeceraTabla($tituloColumnas, $anchoColumnas);
        $archivo->Ln(4);
    } else {
        $archivo       = fopen($nombreArchivo,"a+");
        $titulos_plano = "\"".$textos["NOMBRE"]."\";\"".$textos["PAIS"]."\";\"".$textos["DEPARTAMENTO"]."\";\"".$textos["MUNICIPIO"]."\";\"".$textos["COMUNA"]."\";\"".$textos["ESTRATO"]."\"\n";
    ...
    if(SQL::filasDevueltas($consulta)){
        ...
        while($datos = SQL::filaEnObjeto($consulta)){
            ...
            if($tipo_listado == 1){
                ...
                $archivo->Cell(40, 4, $datos->nombre, 0, 0, "L",true,"",true);
                $archivo->Cell(40, 4, $pais, 0, 0, "L",true,"",true);
                $archivo->Cell(40, 4, $departamento, 0, 0, "L",true,"",true);
                $archivo->Cell(40, 4, $municipio, 0, 0, "L",true,"",true);
                $archivo->Cell(20, 4, $datos->comuna, 0, 0, "R",true,"",true);
                $archivo->Cell(16, 4, $datos->estrato, 0, 0, "R",true,"",true);
                $archivo->Ln(4);
            }else{
                ...
                $contenido = "\"".$datos->nombre."\";\"".$pais."\";\"".$departamento."\";\"".$municipio."\";\"".$datos->comuna."\";\"".$datos->estrato."\"\n";
