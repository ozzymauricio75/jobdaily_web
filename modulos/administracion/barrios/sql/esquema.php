...
$vistas = array(
    array(
        "CREATE OR REPLACE ALGORITHM = MERGE VIEW job_menu_barrios AS
        SELECT
            CONCAT(
                job_localidades.codigo_iso,
                \"|\",
                job_localidades.codigo_dane_departamento,
                \"|\",
                job_localidades.codigo_dane_municipio,
                \"|\",
                job_localidades.tipo,
                \"|\",job_localidades.codigo_dane_localidad
            ) AS id,
        ...
        WHERE
            ...
            job_localidades.tipo = 'B'
            ORDER BY NOMBRE ASC;"
    ),
    array(
        "CREATE OR REPLACE ALGORITHM = MERGE VIEW job_buscador_barrios AS
        SELECT
            CONCAT(
                job_localidades.codigo_iso,
                \"|\",
    ...
    array(
        "CREATE OR REPLACE ALGORITHM = MERGE VIEW job_seleccion_barrios AS
        SELECT
            CONCAT(
                job_localidades.codigo_iso,
                \"|\",
            ...
            CONCAT(
                ...
                '|',
                CONCAT(
                    job_departamentos.codigo_iso,
                    \",\",
                    job_municipios.codigo_dane_departamento,
                    \",\",
                    job_municipios.codigo_dane_municipio,
                    job_localidades.codigo_dane_localidad
                )
            ) AS nombre ,
    ...
    array(
        "CREATE OR REPLACE ALGORITHM = MERGE VIEW job_seleccion_localidades AS
        SELECT
            CONCAT(
                job_localidades.codigo_iso,
                \"|\",
        ...
        WHERE
            ...
            job_localidades.codigo_iso = job_departamentos.codigo_iso AND
            job_localidades.codigo_dane_departamento = job_departamentos.codigo_dane_departamento AND
            job_localidades.codigo_iso = job_paises.codigo_iso
            ORDER BY NOMBRE ASC;"
    )
);
/*
    DROP TABLE IF EXISTS job_menu_barrios;
    DROP TABLE IF EXISTS job_buscador_barrios;
    ...
    SELECT
        CONCAT(job_localidades.codigo_iso, "|",job_localidades.codigo_dane_departamento,"|",job_localidades.codigo_dane_municipio,"|",job_localidades.tipo,"|",job_localidades.codigo_dane_localidad) AS id,
        CONCAT(job_localidades.codigo_iso, "|",job_localidades.codigo_dane_departamento,"|",job_localidades.codigo_dane_municipio,"|",job_localidades.tipo) AS codigo,
        job_localidades.nombre AS nombre,
        job_localidades.codigo_dane_localidad AS codigo_localidad,
        job_localidades.codigo_interno AS codigo_interno,
        job_localidades.estrato AS estrato,
  ...
  CREATE OR REPLACE ALGORITHM = MERGE VIEW job_seleccion_localidades AS
    SELECT
            ...
            CONCAT(
                ...
                ', ', job_departamentos.nombre,
                ', ',job_paises.nombre,
                '|', CONCAT(job_departamentos.codigo_iso,",",job_municipios.codigo_dane_departamento,",",job_municipios.codigo_dane_municipio,",",tipo,",",job_localidades.codigo_dane_localidad)
            ) AS nombre ,

                 job_localidades.codigo_dane_localidad AS codigo,

                 CONCAT(job_localidades.codigo_iso, ",",job_localidades.codigo_dane_departamento,",",job_localidades.codigo_dane_municipio,",",tipo,",",job_localidades.codigo_dane_localidad) AS  llave_primaria
