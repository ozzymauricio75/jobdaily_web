...
$vistaMenu     = "menu_tablas";
$vistaBuscador = "buscador_tablas";
$alineacion    = array("I");
...
$botones  = HTML::boton("ADICTABL",$textos["ADICIONAR"],"ejecutarComando(this, 410, 240);","adicionar");
$botones .= HTML::boton("CONSTABL",$textos["CONSULTAR"],"ejecutarComando(this, 350, 230);","consultar");
$botones .= HTML::boton("MODITABL",$textos["MODIFICAR"],"ejecutarComando(this, 410, 240);","modificar");
$botones .= HTML::boton("ELIMTABL",$textos["ELIMINAR"],"ejecutarComando(this, 350, 230);","eliminar");
