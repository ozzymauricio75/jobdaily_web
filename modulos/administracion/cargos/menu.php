...
$botones  = HTML::boton("ADICCARG",$textos["ADICIONAR"],"ejecutarComando(this,330,300);","adicionar");
$botones .= HTML::boton("CONSCARG",$textos["CONSULTAR"],"ejecutarComando(this,300,280);","consultar");
$botones .= HTML::boton("MODICARG",$textos["MODIFICAR"],"ejecutarComando(this,330,300);","modificar");
$botones .= HTML::boton("ELIMCARG",$textos["ELIMINAR"],"ejecutarComando(this,300,280);","eliminar");
