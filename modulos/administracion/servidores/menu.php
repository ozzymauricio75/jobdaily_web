...
$botones  = HTML::boton("ADICSRVD",$textos["ADICIONAR"],"ejecutarComando(this,450,380);","adicionar");
$botones .= HTML::boton("CONSSRVD",$textos["CONSULTAR"],"ejecutarComando(this,400,380);","consultar");
$botones .= HTML::boton("MODISRVD",$textos["MODIFICAR"],"ejecutarComando(this,450,380);","modificar");
$botones .= HTML::boton("ELIMSRVD",$textos["ELIMINAR"],"ejecutarComando(this,400,380);","eliminar");
