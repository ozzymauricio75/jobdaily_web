...
$botones  = HTML::boton("ADICPAIS",$textos["ADICIONAR"],"ejecutarComando(this, 350, 320);","adicionar");
$botones .= HTML::boton("CONSPAIS",$textos["CONSULTAR"],"ejecutarComando(this, 310, 250);","consultar");
$botones .= HTML::boton("MODIPAIS",$textos["MODIFICAR"],"ejecutarComando(this, 350, 320);","modificar");
$botones .= HTML::boton("ELIMPAIS",$textos["ELIMINAR"],"ejecutarComando(this, 350, 280);","eliminar");
$botones .= HTML::boton("LISTPAIS",$textos["EXPORTAR"],"ejecutarComando(this, 250, 250);","exportar");
