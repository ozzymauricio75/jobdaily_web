...
$botones  = HTML::boton("ADICBODE",$textos["ADICIONAR"],"ejecutarComando(this, 500, 390);","adicionar");
$botones .= HTML::boton("CONSBODE",$textos["CONSULTAR"],"ejecutarComando(this, 360, 360);","consultar");
$botones .= HTML::boton("MODIBODE",$textos["MODIFICAR"],"ejecutarComando(this, 480, 420);","modificar");
$botones .= HTML::boton("ELIMBODE",$textos["ELIMINAR"],"ejecutarComando(this, 360, 360);","eliminar");
