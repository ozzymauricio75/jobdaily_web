...
$botones  = HTML::boton("ADICCORR",$textos["ADICIONAR"],"ejecutarComando(this, 350, 470);","adicionar");
$botones .= HTML::boton("CONSCORR",$textos["CONSULTAR"],"ejecutarComando(this, 350, 360);","consultar");
$botones .= HTML::boton("MODICORR",$textos["MODIFICAR"],"ejecutarComando(this, 350, 470);","modificar");
$botones .= HTML::boton("ELIMCORR",$textos["ELIMINAR"],"ejecutarComando(this, 350, 380);","eliminar");
$botones .= HTML::boton("LISTCORR",$textos["EXPORTAR"],"ejecutarComando(this, 350, 380);","exportar");
