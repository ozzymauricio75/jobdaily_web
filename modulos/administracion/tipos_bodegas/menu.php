...
$botones  = HTML::boton("ADICTIBO",$textos["ADICIONAR"],"ejecutarComando(this, 330, 300);","adicionar");
$botones .= HTML::boton("CONSTIBO",$textos["CONSULTAR"],"ejecutarComando(this, 350, 280);","consultar");
$botones .= HTML::boton("MODITIBO",$textos["MODIFICAR"],"ejecutarComando(this, 330, 300);","modificar");
