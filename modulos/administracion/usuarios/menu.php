...
$botones = HTML::boton("ADICUSUA",$textos["ADICIONAR"],"ejecutarComando(this,500,500);","adicionar");
$botones .= HTML::boton("CONSUSUA",$textos["CONSULTAR"],"ejecutarComando(this,500,500);","consultar");
$botones .= HTML::boton("MODIUSUA",$textos["MODIFICAR"],"ejecutarComando(this,500,500);","modificar");
$botones .= HTML::boton("ELIMUSUA",$textos["ELIMINAR"],"ejecutarComando(this,500,500);","eliminar");
