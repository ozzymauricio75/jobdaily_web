...
$botones  = HTML::boton("ADICEMPR",$textos["ADICIONAR"],"ejecutarComando(this, 750, 520);","adicionar");
$botones .= HTML::boton("CONSEMPR",$textos["CONSULTAR"],"ejecutarComando(this, 750, 550);","consultar");
$botones .= HTML::boton("MODIEMPR",$textos["MODIFICAR"],"ejecutarComando(this, 750, 520);","modificar");
$botones .= HTML::boton("ELIMEMPR",$textos["ELIMINAR"],"ejecutarComando(this, 750, 550);","eliminar");
