...
$botones  = HTML::boton("ADICSECB",$textos["ADICIONAR"],"ejecutarComando(this, 480, 390);","adicionar");
$botones .= HTML::boton("CONSSECB",$textos["CONSULTAR"],"ejecutarComando(this, 350, 280);","consultar");
$botones .= HTML::boton("MODISECB",$textos["MODIFICAR"],"ejecutarComando(this, 480, 390);","modificar");
$botones .= HTML::boton("ELIMSECB",$textos["ELIMINAR"],"ejecutarComando(this, 350, 280);","eliminar");
