...
$botones  = HTML::boton("ADICSUCU",$textos["ADICIONAR"],"ejecutarComando(this, 480, 480);","adicionar");
$botones .= HTML::boton("CONSSUCU",$textos["CONSULTAR"],"ejecutarComando(this, 480, 550);","consultar");
$botones .= HTML::boton("MODISUCU",$textos["MODIFICAR"],"ejecutarComando(this, 480, 570);","modificar");
