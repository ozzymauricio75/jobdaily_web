<?php
    ...
    **/
    ...
    SQL::abrirConexion();
    echo "<p> Carga archivo plano de vigencia tasas <br /></p>\n";
    ...
    $total_insertados = 0;
    $nombreArchivo = $rutasGlobales["archivos"]."/vigencia.csv";
    ...
    if (($archivo = fopen($nombreArchivo, "r")) !== FALSE) {
        ...
        echo "<p> Total vigencias de tasas insertadas $total_insertados <br /></p>\n";
        fclose($archivo);
    }
?>
